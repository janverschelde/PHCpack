...
def pieri_root_count(mdim, pdim, qdeg):
    ...
    """
    from phcpy2c import py2c_pieri_count, py2c_localization_poset
...
def run_pieri_homotopies(mdim, pdim, qdeg, planes, *pts):
    ...
    """
    from phcpy2c import py2c_pieri_count, py2c_pieri_homotopies
...
def real_osculating_planes(mdim, pdim, qdeg):
    ...
    """
    from phcpy2c import py2c_osculating_planes
...
def make_pieri_system(mdim, pdim, qdeg, planes, is_real=False):
    ...
    in the list planes.
    """
    from phcpy2c import py2c_pieri_system
    from phcpy2c import py2c_syscon_load_polynomial
    strplanes = planes_to_string(planes)
