...
-- AUXILIARY OPERATIONS :
  ...
  function Eval_Sys ( n : integer32; p : Poly; ep : Eval_Poly )
                    return Eval_Poly_Sys is
  ...
  procedure Append_Line 
              ( bl,bl_last,vl,vl_last,tl,tl_last : in out List;
                b,v,t : in Vector ) is
  ...
  procedure First_Loop
              ( fp : in Eval_Poly_Sys;
                ...
                deco : in out Link_to_VecVec; nb : in out natural32;
                fail : out boolean ) is
  ...
  procedure First_Loop
              ( file : in file_type;
                fp : in Eval_Poly_Sys; output : in boolean;
                bl,bl_last,vl,vl_last,tl,tl_last : in out List;
                b0,v0,t0 : in Standard_Complex_Vectors.Vector;
                deco : in out Link_to_VecVec; nb : in out natural32;
                fail : out boolean ) is
  ...
  procedure New_Loop
              ( fp : in Eval_Poly_Sys; d : in natural32;
                bl,bl_last,vl,vl_last,tl,tl_last : in out List;
                b0,v0,t0 : in Standard_Complex_Vectors.Vector;
                deco : in out Link_to_VecVec; nb,scnt : in out natural32;
                fail : out boolean ) is
...
-- TARGET PROCEDURES :
  ...
  procedure Monodromy_Breakup
                ( file : in file_type; 
                  ...
                  output : in boolean; deco : in out Link_to_VecVec ) is
