...
package Intrinsic_Diagonal_Homotopies is

-- DESCRIPTION :
--   A diagonal homotopy allows to compute witness sets for all
--   components of the intersection of two positive dimensional
--   solution sets.  The intrinsic version uses a basis for the
--   linear spaces which cut out the witness sets.
...
--   Randomize whenever necessary before applying diagonal homotopies.
  ...
  function Minimal_Intersection_Dimension ( n,a,b : natural ) return natural;
