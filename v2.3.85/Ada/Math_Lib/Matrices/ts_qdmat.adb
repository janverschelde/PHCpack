...
procedure ts_qdmat is

-- DESCRIPTION :
--   Tests the quad double matrix packages.
  ...
  --   a randomly generated matrix.
    ...
    use Quad_Double_Matrices,Quad_Double_Matrices_io;
  ...
  procedure Test_Quad_Double_Complex_Matrices is
    ...
    use QuadDobl_Complex_Matrices,QuadDobl_Complex_Matrices_io;
