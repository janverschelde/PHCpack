...
procedure ts_ddmat is

-- DESCRIPTION :
--   Simple test on generating random matrices of double doubles.
  ...
  --   a randomly generated matrix.
    ...
    use Double_Double_Matrices,Double_Double_Matrices_io;
  ...
  --   and then shows a matrix of random complex double doubles.
    ...
    use DoblDobl_Complex_Matrices,DoblDobl_Complex_Matrices_io;
