...
with Standard_Floating_GramSchmidt; -- for the maximum function

package body Standard_Complex_GramSchmidt is
...
--   working with qk and vj as below doubled the execution speed!
  ...
  procedure QR ( n,m : in integer32;
                 q,r : in out Standard_Complex_VecVecs.VecVec ) is

    w : Complex_Number;
    wr : double_float;
    qk,qj,rj,rk : Standard_Complex_Vectors.Link_to_Vector;
  ...
  procedure Swap ( v : in out Standard_Complex_VecVecs.VecVec;
                   i,j : in integer32 ) is

    w : constant Standard_Complex_Vectors.Link_to_Vector := v(i);
  ...
  procedure Permute_Upper_Triangular
               ( n : in integer32;
                 r : in out Standard_Complex_VecVecs.VecVec;
  ...
  procedure QR ( n,m : in integer32; tol : in double_float;
                 q,r : in out Standard_Complex_VecVecs.VecVec;
  ...
  procedure Test_Orthonormality
               ( n,m : in integer32;
                 q : in Standard_Complex_VecVecs.VecVec;
  ...
  procedure Test_Decomposition
              ( n,m : in integer32;
                v,q,r : in Standard_Complex_VecVecs.VecVec;
                tol : in double_float; output : in boolean;
                maxerr : out double_float; fail : out boolean ) is
  ...
  function Matrix_Product
    ...
    res : Standard_Complex_Vectors.Vector(1..n) := (1..n => Create(0.0));
    vj : Standard_Complex_Vectors.Link_to_Vector;
  ...
  function Matrix_Projection
              ( n,m : integer32;
                q : Standard_Complex_VecVecs.VecVec;
                b : Standard_Complex_Vectors.Vector )
              return Standard_Complex_Vectors.Vector is

    res : Standard_Complex_Vectors.Vector(1..m);
    w : Complex_Number;
  ...
  procedure Orthogonal_Projection
              ( n,m : in integer32;
                ...
                qb : out Standard_Complex_Vectors.Vector ) is

    w : Complex_Number;
    qk : Standard_Complex_Vectors.Link_to_Vector;
  ...
  function Solve ( m : integer32;
                   r : Standard_Complex_VecVecs.VecVec;
                   b : Standard_Complex_Vectors.Vector )
                 return Standard_Complex_Vectors.Vector is

    res : Standard_Complex_Vectors.Vector(1..m) := b;
    rk : Standard_Complex_Vectors.Link_to_Vector;
    w : Complex_Number;
...
end Standard_Complex_GramSchmidt;
