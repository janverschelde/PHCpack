...
package body DoblDobl_Monomial_Evaluations is
  ...
  function Eval ( e : Standard_Natural_VecVecs.VecVec;
    ...
    res : DoblDobl_Complex_Vectors.Vector(e'range);
  ...
  begin
    if maxdeg = 0 then
      declare
        powtab : DoblDobl_Complex_Matrices.Matrix(1..n,1..1);
      begin
        for i in 1..n loop
          powtab(i,1) := x(i);
        end loop;
      ...
      declare
        powtab : DoblDobl_Complex_Matrices.Matrix(1..n,1..maxdeg);
      begin
