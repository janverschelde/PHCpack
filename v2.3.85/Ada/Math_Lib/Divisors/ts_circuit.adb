...
procedure ts_circuit is
  ...
  --   after prompting the user for bounds on the numbers.
  ...
  -- DESCRIPTION :
  --   Prompts the user for a number less than or equal to d
  ...
  -- DESCRIPTION :
  --   Prompts the user for a selection of rows and then uses this
