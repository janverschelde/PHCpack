...
procedure ts_smith is

-- DESCRIPTION :
--   Development of Smith Normal Form of an integer matrix.
  ...
  -- DESCRIPTION :
  --   Test Smith normal form on a given matrix.
  ...
  -- DESCRIPTION :
  --   Test on the Smith normal form of a matrix,
  ...
  -- DESCRIPTION :
  --   Test Smith normal form on a given n-by-m matrix,
  --   using standard 32-bit integer arithmetic.
  ...
  -- DESCRIPTION :
  --   Test Smith normal form on randomly generated n-by-m matrices,
  --   using standard 32-bit integer arithmetic.
