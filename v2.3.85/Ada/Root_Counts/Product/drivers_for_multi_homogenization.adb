...
package body Drivers_for_Multi_Homogenization is
  ...
  procedure Driver_for_Multi_Homogenization
    ...
    procedure Display_Menu ( choice : out character; gb : in natural32 ) is
    ...
    procedure Dispatch_Menu ( choice : in character; gb : in out natural32 ) is
    ...
    procedure Driver_for_Partitions
                  ( file : in file_type; gb : in out natural32 ) is
