...
--  procedure Enumerate ( d : in Standard_Natural_Vectors.Vector ) is
--
--  -- DESCRIPTION :
--  --   Writes all possible choices of elements ranging between 1 and d(i),
--  --   for i in d'range.
--
--    n : constant natural := d'last;
--    cont : boolean := true;
--    cnt : natural := 0;
...
--  end Enumerate;
  ...
  begin
    ...
    if ans = '1'
     ...
     else put("Give the number of equations : "); get(n);
