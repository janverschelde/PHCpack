...
package Standard_Integer64_Simplices is

-- DESCRIPTION :
--   The simplices are facets on the lower hull of a lifted polytope
--   spanned by standard 64-bit integer vectors.
...
-- SELECTORS :
  ...
  function Volume ( s : Simplex ) return natural64;
...
end Standard_Integer64_Simplices;
