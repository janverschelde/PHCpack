...
package Standard_Binomial_Solvers is
...
-- SOLVERS for UPPER TRIANGULAR systems :
  ...
  function Rank ( U : Standard_Integer_Matrices.Matrix ) return integer32;
  function Rank ( U : Multprec_Integer_Matrices.Matrix ) return integer32;

  -- DESCRIPTION :
  --   Returns the rank of the upper triangular matrix U.

  function Degree ( U : Standard_Integer_Matrices.Matrix ) return integer32;
  ...
  function Solve_Upper_Square
             ( U : Standard_Integer_Matrices.Matrix;
               c : Standard_Complex_Vectors.Vector ) return Solution_List;
  function Solve_Upper_Square
  ...
  procedure Solve_Upper_General
              ( U : in Standard_Integer_Matrices.Matrix;
                ...
                f,ext_c : out Standard_Complex_Vectors.Vector );
  procedure Solve_Upper_General
              ( file : in file_type;
                U : in Standard_Integer_Matrices.Matrix;
                c : in Standard_Complex_Vectors.Vector;
  ...
  procedure Solve_Upper_General
              ( U : in Standard_Integer_Matrices.Matrix;
                ...
                sols : out Solution_List;
                ext_U : out Standard_Integer_Matrices.Matrix;
                ext_c : out Standard_Complex_Vectors.Vector );
  procedure Solve_Upper_General
              ( file : in file_type;
                U : in Standard_Integer_Matrices.Matrix;
                c,f : in Standard_Complex_Vectors.Vector;
