...
static PyObject *py2c_pieri_system ( PyObject *self, PyObject *args )
{
   int fail,m,p,q,nc,r;
   char *A;
...
static PyMethodDef phcpy2c_methods[] = 
{
   ...
   {"py2c_copy_container_to_start_system", py2c_copy_container_to_start_system,
   ...
   {"py2c_create_quaddobl_homotopy_with_gamma",
     py2c_create_quaddobl_homotopy_with_gamma,
    METH_VARARGS, "makes a quaddouble homotopy with given gamma constant"},
   ...
   {"py2c_clear_homotopy", py2c_create_homotopy,
   ...
   {"py2c_solve_by_homotopy_continuation",
    py2c_solve_by_homotopy_continuation,
    METH_VARARGS, "uses homotopy continuation to solve"},
