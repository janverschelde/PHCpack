...
package body Standard_Embed_Polynomials is
  ...
  function Add_Variables ( p : Matrix; k : natural32 ) return Matrix is

    res : Matrix(p'range(1),p'range(2));
...
end Standard_Embed_Polynomials;
