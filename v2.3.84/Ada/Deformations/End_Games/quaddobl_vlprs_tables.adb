...
package body QuadDobl_vLpRs_Tables is

-- I. The v-table :

  procedure v_pipe ( v : in out Vector; p : in Vector;
                     vr : in quad_double ) is

    tmp0,tmp1 : quad_double;
  ...
  procedure v_pipe ( v,p : in Vector; vr : in quad_double;
...
-- II. The L-table :
  ...
  procedure L_pipe ( l,p : in Vector; lr : in quad_double;
...
-- V. The s-table :
  ...
  procedure s_pipe ( srp : in out Vector; sr : in quad_double;
                     dsp : out Vector ) is

    tmp : quad_double := srp(1);
    srpow : quad_double := sr;
  ...
  procedure s_pipe ( sr1 : in Vector; sr : in quad_double;
