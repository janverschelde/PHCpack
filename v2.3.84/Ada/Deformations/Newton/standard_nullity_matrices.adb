...
with Standard_Nullity_Polynomials;      use Standard_Nullity_Polynomials;
 
package body Standard_Nullity_Matrices is
  ...
  begin
    if k = 1 then
      ...
      Dimensions_of_Nullity_Matrix(nq,nv,k-1,nr1,nc1);
      declare
        nm1 : constant Standard_Complex_Poly_Matrices.Matrix
  ...
  function Eval0 ( nm : Standard_Complex_Poly_Matrices.Matrix;
    ...
    res : Standard_Complex_Matrices.Matrix(nm'range(1),nm'range(2));
