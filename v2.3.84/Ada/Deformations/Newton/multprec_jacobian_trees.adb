...
package body Multprec_Jacobian_Trees is
...
-- EVALUATORS :
  ...
  begin
    for i in 0..k loop
      declare
        mci : constant integer32
            := integer32(Monomial_Count(natural32(i),natural32(n)));
        vmi : VecMat(1..mci);
      begin
...
-- DESTRUCTORS :
  ...
  begin
    for i in jrt'range loop
      Multprec_Complex_VecMats.Deep_Clear(jrt(i));
    end loop;
  end Clear;

end Multprec_Jacobian_Trees;
