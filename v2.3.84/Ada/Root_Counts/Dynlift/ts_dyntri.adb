...
with Standard_Integer_Triangulations;
with Standard_Integer_Triangulations_io; use Standard_Integer_Triangulations_io;
...
with Standard64_Dynamic_Triangulations;  use Standard64_Dynamic_Triangulations;
...
--   Test the creation of a regular triangulation by dynamic lifting.
  ...
  --   Uses standard 32-bit arithmetic to compute a regular triangulation.
    ...
    t : Standard_Integer_Triangulations.Triangulation;
