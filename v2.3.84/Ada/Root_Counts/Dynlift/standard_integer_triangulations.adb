...
package body Standard_Integer_Triangulations is
...
-- AUXILIAIRY HASH TABLE FOR Update_One :
  ...
  --   Computes the entries in the hash table for the simplex s.
    ...
    r1 : constant integer32 := ht.weight1.all*Vertex(s,1);
    r2 : constant integer32 := ht.weight2.all*Vertex(s,2);
...
--  end Is_In1;
  ...
  function Volume ( t : Triangulation ) return natural32 is
...
end Standard_Integer_Triangulations;
