...
function use_c2phc ( job : integer32;
  ...
  begin
    case job is
      ...
      when 110..115 => return use_roco(job-110,a,b,c);
     ...
     -- double double versions for jobs 1 to 9
     ...
     -- quad double versions for jobs 1 to 9
     ...
     -- path trackers with generators :
      when 500..511 => return use_nxtsol(job-500,a,b,c);
