  ...
  begin
    case job is
     ...
     -- degrees of polynomials :
      ...
      when 209 => return Job209; -- degree of double double polynomial
      when 219 => return Job219; -- degree of quad double polynomial
     ...
     -- jobs for interchanging polynomial as strings :
      ...
      when 208 => return Job208; -- store dobldobl polynomial in container
      when 218 => return Job218; -- store quaddobl polynomial in container
