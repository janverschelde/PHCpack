...
function use_nxtsol ( job : integer32;
  ...
  begin
    case job is
      ...
      when 9 => return Job9;   -- clear standard path tracker
      when 10 => return Job10; -- clear double double path tracker
      when 11 => return Job11; -- clear quad double path tracker
