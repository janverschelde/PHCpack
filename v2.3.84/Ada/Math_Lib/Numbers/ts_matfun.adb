...
procedure ts_matfun is
  ...
  -- DESCRIPTION :
  --   Prompts the user to read a floating number with given variable name.
  ...
  -- DESCRIPTION :
  --   Allows the user to give in various numbers to test the SQRT on.
