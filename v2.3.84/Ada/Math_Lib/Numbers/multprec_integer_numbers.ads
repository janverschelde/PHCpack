...
-- CREATORS :
  ...
  function Create ( i : integer32 ) return Integer_Number;
  ...
  function Create ( i : Integer_Number ) return integer32;
...
-- SELECTORS :
  ...
  function Coefficient ( i : Integer_Number; k : natural32 ) return natural32;
...
-- COMPARISON AND COPYING :
  ...
  function Equal ( i1 : Integer_Number; i2 : integer32 ) return boolean;
  function Equal ( i1,i2 : Integer_Number ) return boolean;

  -- DESCRIPTION :
  --   Returns true when both numbers i1 and i2 are equal, false otherwise.

  function "<" ( i1 : Integer_Number; i2 : integer32 ) return boolean;
  function "<" ( i1 : integer32; i2 : Integer_Number ) return boolean;
  ...
  procedure Copy ( i1 : in integer32; i2 : in out Integer_Number );
...
-- ARITHMETIC OPERATIONS as functions (no data sharing) :
  ...
  function "+" ( i1 : Integer_Number; i2 : integer32 ) return Integer_Number;
  function "+" ( i1 : integer32; i2 : Integer_Number ) return Integer_Number;
  ...
  function "**" ( i : Integer_Number; n : natural32 ) return Integer_Number;
  function "**" ( i : integer32; n : Natural_Number ) return Integer_Number;
  function "**" ( i : Integer_Number; n : Natural_Number )
                return Integer_Number;

  function "/" ( i1 : Integer_Number; i2 : integer32 ) return Integer_Number;
  function "/" ( i1 : integer32; i2 : Integer_Number ) return integer32;
  function "/" ( i1,i2 : Integer_Number ) return Integer_Number;

  function Rmd ( i1 : Integer_Number; i2 : integer32 ) return integer32;
  function Rmd ( i1 : integer32; i2 : Integer_Number ) return integer32;
...
-- ARITHMETIC OPERATIONS as procedures for memory management :
  ...
  procedure Add ( i1 : in out Integer_Number; i2 : in integer32 );    -- "+"
  procedure Add ( i1 : in out Integer_Number; i2 : in Integer_Number );

  procedure Min ( i : in out Integer_Number );
  procedure Set_Min ( i : in out Integer_Number ); -- also allows -0

  procedure Sub ( i1 : in out Integer_Number; i2 : in integer32 );    -- "-"
  procedure Sub ( i1 : in out Integer_Number; i2 : in Integer_Number );

  procedure Mul ( i1 : in out Integer_Number; i2 : in integer32 );    -- "*"
  procedure Mul ( i1 : in out Integer_Number; i2 : in Integer_Number );

  procedure Rmd ( i1 : in out Integer_Number; i2 : in integer32 );
  ...
  procedure Div ( i1 : in Integer_Number; i2 : in integer32;  -- i1 = i2*q+r
                  q : out Integer_Number; r : out integer32 );
  procedure Div ( i1 : in out Integer_Number; i2 : in integer32;
                  r : out integer32 );
