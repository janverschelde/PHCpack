...
with Witness_Points_Formats;            use Witness_Points_Formats;
with Extrinsic_Diagonal_Homotopies;     use Extrinsic_Diagonal_Homotopies;
with Intrinsic_Diagonal_Homotopies;     use Intrinsic_Diagonal_Homotopies;
with Multihomogeneous_Solutions;        use Multihomogeneous_Solutions;

package body Intrinsic_Diagonal_Solvers is
  ...
  procedure Filter_by_Evaluation
    ...
    newsols : Solution_List := Expand(sols,b,v);
