...
-- CONSTRUCTORS :
  ...
  procedure Convex_Hull_of_Ridge
              ( A : in Matrix; v : in Standard_Integer64_Vectors.Vector;
                ...
                p : out integer; M : out Matrix; F : out Facet_List ) is
 ...
 --     put_line("B2 = "); put(B2); raise;
  ...
  begin
    ...
    declare
      mc : constant natural := Length_Of(Cf);
      res : Facet(d,n,mc);
      ptr : Facet_List;
    begin
  ...
  procedure Connect_along_Ridge
               ( f : in Link_to_Facet; r : in natural ) is
...
-- SELECTORS :
  ...
  function Vertices ( n : natural; f : Array_of_Facets )
                    return Standard_Integer_Vectors.Vector is
  ...
  function Faces ( f : Facet_List; d : natural )
                 return Lists_of_Integer_Vectors.List is
  ...
  function Faces ( f : Array_of_Facets; d : natural )
                 return Lists_of_Integer_Vectors.List is
  ...
  function fvector ( n,d : natural; f : Facet_List )
