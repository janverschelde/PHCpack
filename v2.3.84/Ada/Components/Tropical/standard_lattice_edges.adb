...
package body Standard_Lattice_Edges is
...
-- CONSTRUCTORS :
  ...
  function Edges_of_3D_Hull
    ...
    cnt : natural := 0;        -- defines the labels of the edges

    procedure Append_New_Edge
                  ( p,q : in natural; pf,qf : in Link_to_3d_Facet ) is
    ...
    -- DESCRIPTION :
    --   The adjusted Standard_Lattice_Facets.Crawl appends edges
