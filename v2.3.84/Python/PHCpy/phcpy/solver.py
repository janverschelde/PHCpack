...
def load_system():
    ...
    """
    from phcpy.phcpy2c import py2c_syscon_number_of_polynomials
...
def store_solutions(nvar, sols):
    ...
    from phcpy.phcpy2c import py2c_solcon_append_solution_string
...
def store_dobldobl_solutions(nvar, sols):
    ...
    from phcpy.phcpy2c import py2c_solcon_append_dobldobl_solution_string
...
def store_quaddobl_solutions(nvar, sols):
    ...
    from phcpy.phcpy2c import py2c_solcon_append_quaddobl_solution_string
...
def load_dobldobl_solutions():
    ...
    """
    from phcpy.phcpy2c import py2c_solcon_number_of_dobldobl_solutions
    from phcpy.phcpy2c import py2c_solcon_length_dobldobl_solution_string
    from phcpy.phcpy2c import py2c_solcon_write_dobldobl_solution_string
...
def load_quaddobl_solutions():
    ...
    for complex double double solutions.
    """
    from phcpy.phcpy2c import py2c_solcon_number_of_quaddobl_solutions
    from phcpy.phcpy2c import py2c_solcon_length_quaddobl_solution_string
    from phcpy.phcpy2c import py2c_solcon_write_quaddobl_solution_string
...
def solve(pols, silent=False):
    ...
    """
    from phcpy.phcpy2c import py2c_syscon_clear_Laurent_system
    from phcpy.phcpy2c import py2c_syscon_initialize_number_of_Laurentials
    from phcpy.phcpy2c import py2c_syscon_store_Laurential
    from phcpy.phcpy2c import py2c_solcon_clear_solutions
    from phcpy.phcpy2c import py2c_solve_Laurent_system
...
def standard_double_track(target, start, sols, gamma=0):
    ...
    """
    from phcpy.phcpy2c import py2c_copy_container_to_target_system
    ...
    from phcpy.phcpy2c import py2c_create_homotopy
    from phcpy.phcpy2c import py2c_create_homotopy_with_gamma
...
def initialize_standard_tracker(target, start):
    ...
    from phcpy.phcpy2c import py2c_copy_container_to_target_system
    from phcpy.phcpy2c import py2c_copy_container_to_start_system
    from phcpy.phcpy2c import py2c_initialize_standard_homotopy
    store_system(target)
    py2c_copy_container_to_target_system()
    store_system(start)
    py2c_copy_container_to_start_system()
...
def initialize_dobldobl_tracker(target, start):
    ...
    from phcpy.phcpy2c import py2c_copy_dobldobl_container_to_target_system
    from phcpy.phcpy2c import py2c_copy_dobldobl_container_to_start_system
    from phcpy.phcpy2c import py2c_initialize_dobldobl_homotopy
    store_dobldobl_system(target)
    py2c_copy_dobldobl_container_to_target_system()
    store_dobldobl_system(start)
    py2c_copy_dobldobl_container_to_start_system()
...
def initialize_quaddobl_tracker(target, start):
    ...
    from phcpy.phcpy2c import py2c_copy_quaddobl_container_to_target_system
    from phcpy.phcpy2c import py2c_copy_quaddobl_container_to_start_system
    from phcpy.phcpy2c import py2c_initialize_quaddobl_homotopy
    store_quaddobl_system(target)
    py2c_copy_quaddobl_container_to_target_system()
    store_quaddobl_system(start)
    py2c_copy_quaddobl_container_to_start_system()
...
def initialize_standard_solution(nvar, sol):
    ...
    """
    from phcpy.phcpy2c import py2c_initialize_standard_solution
...
def initialize_dobldobl_solution(nvar, sol):
    ...
    solution sol and sol is a PHCpack solution string.
    """
    from phcpy.phcpy2c import py2c_initialize_dobldobl_solution
...
def initialize_quaddobl_solution(nvar, sol):
    ...
    solution sol and sol is a PHCpack solution string.
    """
    from phcpy.phcpy2c import py2c_initialize_quaddobl_solution
...
def next_standard_solution():
    ...
    """
    from phcpy.phcpy2c import py2c_next_standard_solution
    from phcpy.phcpy2c import py2c_solcon_length_solution_string
    from phcpy.phcpy2c import py2c_solcon_write_solution_string
...
def next_dobldobl_solution():
    ...
    have been executed properly.
    """
    from phcpy.phcpy2c import py2c_next_dobldobl_solution
    from phcpy.phcpy2c import py2c_solcon_length_dobldobl_solution_string
    from phcpy.phcpy2c import py2c_solcon_write_dobldobl_solution_string
...
def next_quaddobl_solution():
    ...
    have been executed properly.
    """
    from phcpy.phcpy2c import py2c_next_quaddobl_solution
    from phcpy.phcpy2c import py2c_solcon_length_quaddobl_solution_string
    from phcpy.phcpy2c import py2c_solcon_write_quaddobl_solution_string
...
def newton_step(system, solutions, precision='d'):
    """
    ...
    if(precision == 'd'):
        ...
        from phcpy.phcpy2c import py2c_quaddobl_Newton_step
...
def deflate(system, solutions):
    ...
    """
    from phcpy.phcpy2c import py2c_deflate
    store_system(system)
    store_solutions(len(system), solutions)
    py2c_deflate()
    result = load_solutions()
...
def total_degree(pols):
    ...
    """
    from phcpy.phcpy2c import py2c_syscon_total_degree
    store_system(pols)
...
def total_degree_start_system(pols):
    ...
    from phcpy.phcpy2c import py2c_syscon_degree_of_polynomial
    store_system(pols)
    dim = py2c_syscon_number_of_polynomials()
...
def linear_product_root_count(pols, silent=False):
    ...
    """
    from phcpy.phcpy2c import py2c_product_supporting_set_structure
    from phcpy.phcpy2c import py2c_product_write_set_structure
    from phcpy.phcpy2c import py2c_product_linear_product_root_count
    store_system(pols)
...
def random_linear_product_system(pols, tosolve=True):
    ...
    """
    from phcpy.phcpy2c import py2c_product_supporting_set_structure
    from phcpy.phcpy2c import py2c_product_random_linear_product_system
    from phcpy.phcpy2c import py2c_product_solve_linear_product_system
    store_system(pols)
    py2c_product_supporting_set_structure()
...
def mixed_volume(pols, stable=False):
    ...
    """
    from phcpy.phcpy2c import py2c_celcon_clear_container
    from phcpy.phcpy2c import py2c_syscon_clear_Laurent_system
    from phcpy.phcpy2c import py2c_syscon_initialize_number_of_Laurentials
    from phcpy.phcpy2c import py2c_syscon_store_Laurential
    from phcpy.phcpy2c import py2c_mixed_volume
...
def random_coefficient_system(silent=False):
    ...
    """
    from phcpy.phcpy2c import py2c_celcon_create_random_coefficient_system
    from phcpy.phcpy2c import py2c_celcon_copy_into_systems_container
    from phcpy.phcpy2c import py2c_celcon_create_polyhedral_homotopy
    from phcpy.phcpy2c import py2c_celcon_number_of_cells
    from phcpy.phcpy2c import py2c_solcon_clear_solutions
    from phcpy.phcpy2c import py2c_celcon_solve_start_system
    from phcpy.phcpy2c import py2c_celcon_track_solution_path
    from phcpy.phcpy2c import py2c_celcon_copy_target_solution_to_container
...
def permute_system(pols):
    ...
    """
    from phcpy.phcpy2c import py2c_celcon_permute_system
    store_system(pols)
