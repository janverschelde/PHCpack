...
def is_binomial_system(silent=True):
    ...
    """
    from phcpy.phcpy2c import py2c_syscon_number_of_Laurentials
...
def monomial_map_strings(dim, ind, nbvar):
    ...
    """
    from phcpy.phcpy2c import py2c_mapcon_coefficients_of_map
    from phcpy.phcpy2c import py2c_mapcon_exponents_of_map
...
def monomial_map_solutions(nbvar, with_degree=True):
    ...
    """
    from phcpy.phcpy2c import py2c_mapcon_top_dimension
    from phcpy.phcpy2c import py2c_mapcon_number_of_maps
    from phcpy.phcpy2c import py2c_mapcon_degree_of_map
    result = []
...
def solve_binomials(nbvar, pols, silent=True, puretopdim=False):
    ...
    """
    from phcpy.phcpy2c import py2c_syscon_write_Laurent_system
    from phcpy.phcpy2c import py2c_mapcon_solve_system
    from phcpy.phcpy2c import py2c_mapcon_write_maps
    from phcpy.phcpy2c import py2c_mapcon_clear_maps
...
def test():
    ...
    maps = solve_binomials(3, twisted2)
    for solmap in maps:
        print solmap
