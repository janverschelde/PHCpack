/* file poly_gcd.c provides an implementation of the extended gcd method */
#include <stdlib.h>
#include "dc_roots.h"
#include "poly_gcd.h"
...
void gcd (int n, dcmplx a[n], int m, dcmplx b[m], int *l, dcmplx ra[n-1], dcmplx
rb[m-1] )
{
  double eps = 1.0e-12;
  double tol = 1.0e-8;
...
POLY get_gcd(POLY a, POLY b)
{
  ...
  {
    gcd( a.d+1, a.p, b.d+1, b.p, &dgcd, ra, rb );
    c.d = dgcd;
