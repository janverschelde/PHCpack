 ...
 * linked with the double double version of the Path library. */
...
/* The wrapping of Newton's method and path trackers with the evaluation
 * done by algorithmic differentiation in double double precision on the GPU 
 * by the functions in gpupath_dd.h, starts here. */
