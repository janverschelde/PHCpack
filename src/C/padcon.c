...
int padcon_set_default_parameters(void) {
  ...
  fail = _ada_use_c2phc(735, a, b, c, 0);
...
int padcon_clear_parameters(void) {
  ...
  fail = _ada_use_c2phc(736, a, b, c, 0);
...
int padcon_write_homotopy_continuation_parameters_to_defined_output(void) {
  ...
  fail = _ada_use_c2phc(874, a, b, c, 0);
...
int padcon_get_homotopy_continuation_parameter(int k, double *val) {
  ...
  if ((k == 2) || (k == 3) || (k == 11) || (k == 12)) {
    fail = _ada_use_c2phc(737, &k, &parval, val, 0);
...
int padcon_set_homotopy_continuation_parameter(int k, double *val) {
  ...
  if ((k == 2) || (k == 3) || (k == 11) || (k == 12)) {
    ...
    fail = _ada_use_c2phc(738, &k, &parval, val, 0);
  } else
    fail = _ada_use_c2phc(738, &k, &parval, val, 0);
...
int padcon_reset_homotopy_continuation_parameters(int prc) {
  ...
  fail = _ada_use_c2phc(740, &prc, b, c, 0);
...
void padcon_standard_multi_projective_transformation(int n, int m, int *idz) {
  int fail;
...
void padcon_dobldobl_multi_projective_transformation(int n, int m, int *idz) {
  int fail;
...
void padcon_quaddobl_multi_projective_transformation(int n, int m, int *idz) {
  int fail;
...
int padcon_standard_track(int nbc, char *name, int locfile, int verbose,
                          int mhom, int nvr, int *idz) {
  int fail, idx;
  int pars[6];
  int *b;
  double *c;
  ...
  if (mhom < 2) {
    if (nbc == 0)
      fail = _ada_use_c2phc(739, pars, b, c, 0);
    else {
      int iname[nbc];
      for (idx = 0; idx < nbc; idx++)
        iname[idx] = (int)name[idx];
      fail = _ada_use_c2phc(739, pars, iname, c, 0);
    }
  } else {
    double z[nvr];
    for (int idx = 0; idx < nvr; idx++)
      z[idx] = (double)idz[idx];

    if (nbc == 0)
      fail = _ada_use_c2phc(739, pars, b, z, 0);
    else {
      int iname[nbc];
      for (int i = 0; i < nbc; i++)
        iname[i] = (int)name[i];
      fail = _ada_use_c2phc(739, pars, iname, z, 0);
    }
  }
  return fail;
}

int padcon_dobldobl_track(int nbc, char *name, int locfile, int verbose,
                          int mhom, int nvr, int *idz) {
  int fail, idx;
  int pars[6];
  int *b;
...
int padcon_quaddobl_track(int nbc, char *name, int locfile, int verbose,
                          int mhom, int nvr, int *idz) {
  int fail, idx;
  int pars[6];
  int *b;
...
int padcon_standard_initialize_homotopy(int verbose, int homo) {
  ...
  fail = _ada_use_c2phc(860, &precision, pars, c, 0);
...
int padcon_standard_initialize_parameter_homotopy(int idx, int verbose) {
  ...
  fail = _ada_use_c2phc(878, &precision, pars, c, 0);
...
int padcon_initialize_standard_solution(int idx, int verbose) {
  ...
  fail = _ada_use_c2phc(861, pars, &verbose, c, 0);
...
int padcon_standard_predict_correct(int *fail, int verbose) {
  ...
  callfail = _ada_use_c2phc(862, &precision, &verbose, c, 0);
...
int padcon_get_standard_solution(int idx, int verbose) {
  ...
  fail = _ada_use_c2phc(863, pars, &verbose, c, 0);
...
int padcon_get_standard_pole_radius(double *frp) {
  ...
  fail = _ada_use_c2phc(865, &precision, b, frp, 0);
...
int padcon_get_standard_closest_pole(double *cre, double *cim) {
  ...
  fail = _ada_use_c2phc(866, &precision, b, nbr, 0);
...
int padcon_get_standard_t_value(double *tval) {
  ...
  fail = _ada_use_c2phc(867, &precision, b, tval, 0);
...
int padcon_get_standard_step_size(double *step) {
  ...
  fail = _ada_use_c2phc(868, &precision, b, step, 0);
...
int padcon_get_standard_series_step(double *step) {
  ...
  fail = _ada_use_c2phc(885, &precision, b, step, 0);
...
int padcon_get_standard_pole_step(double *step) {
  ...
  fail = _ada_use_c2phc(886, &precision, b, step, 0);
...
int padcon_get_standard_estimated_distance(double *eta) {
  ...
  fail = _ada_use_c2phc(887, &precision, b, eta, 0);
...
int padcon_get_standard_hessian_step(double *step) {
  ...
  fail = _ada_use_c2phc(888, &precision, b, step, 0);
...
int padcon_get_standard_series_coefficient(int leadidx, int idx, int verbose,
  ...
  fail = _ada_use_c2phc(869, inpars, &verbose, nbr, 0);
...
int padcon_get_dobldobl_series_coefficient(int leadidx, int idx, int verbose,
                                           double *cre, double *cim) {
  int fail;
  int inpars[3];
  double nbr[2];
...
int padcon_get_quaddobl_series_coefficient(int leadidx, int idx, int verbose,
                                           double *cre, double *cim) {
  int fail;
  int inpars[3];
  double nbr[2];
...
int padcon_get_standard_numerator_coefficient(int leadidx, int idx, int verbose,
                                              double *cre, double *cim) {
  int fail;
  int inpars[4];
  double nbr[2];
  ...
  fail = _ada_use_c2phc(870, inpars, &verbose, nbr, 0);
...
int padcon_get_dobldobl_numerator_coefficient(int leadidx, int idx, int verbose,
                                              double *cre, double *cim) {
  int fail;
  int inpars[4];
  double nbr[2];
...
int padcon_get_quaddobl_numerator_coefficient(int leadidx, int idx, int verbose,
                                              double *cre, double *cim) {
  int fail;
  int inpars[4];
  double nbr[2];
...
int padcon_get_standard_denominator_coefficient(int leadidx, int idx,
                                                int verbose, double *cre,
                                                double *cim) {
  int fail;
  int inpars[4];
  double nbr[2];
...
int padcon_get_dobldobl_denominator_coefficient(int leadidx, int idx,
                                                int verbose, double *cre,
                                                double *cim) {
  int fail;
  int inpars[4];
...
int padcon_get_quaddobl_denominator_coefficient(int leadidx, int idx,
                                                int verbose, double *cre,
                                                double *cim) {
  int fail;
  int inpars[4];
...
int padcon_get_standard_pole(int leadidx, int poleidx, int verbose, double *cre,
                             double *cim) {
  int fail;
  int inpars[3];
  double nbr[2];
  ...
  fail = _ada_use_c2phc(871, inpars, &verbose, nbr, 0);
...
int padcon_get_dobldobl_pole(int leadidx, int poleidx, int verbose, double *cre,
                             double *cim) {
  int fail;
  int inpars[3];
  double nbr[2];
...
int padcon_get_quaddobl_pole(int leadidx, int poleidx, int verbose, double *cre,
                             double *cim) {
  int fail;
  int inpars[3];
  double nbr[2];
...
int padcon_clear_standard_data(void) {
  ...
  fail = _ada_use_c2phc(864, &precision, b, c, 0);
