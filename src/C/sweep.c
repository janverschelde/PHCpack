...
int sweep_define_parameters_numerically(int nq, int nv, int np, int *pars) {
  ...
  nqvp[1] = nv;
  nqvp[2] = np;
  fail = _ada_use_c2phc(610, nqvp, pars, c, 0);
...
int sweep_define_parameters_symbolically(int nq, int nv, int np, int nc,
  ...
  fail = _ada_use_c2phc(611, nqvp, idx, c, 0);
...
int sweep_get_number_of_equations(int *n) {
  ...
  fail = _ada_use_c2phc(612, n, b, c, 0);
...
int sweep_get_number_of_variables(int *n) {
  ...
  fail = _ada_use_c2phc(613, n, b, c, 0);
...
int sweep_get_number_of_parameters(int *n) {
  ...
  fail = _ada_use_c2phc(614, n, b, c, 0);
...
int sweep_get_indices_numerically(int *idx) {
  ...
  fail = _ada_use_c2phc(615, idx, b, c, 0);
...
int sweep_get_indices_symbolically(int *nc, char *pars) {
  ...
  fail = sweep_get_number_of_parameters(&np);
  {
    ...
    fail = _ada_use_c2phc(617, nc, buf, c, 0);
...
int sweep_clear_definitions(void) {
  ...
  fail = _ada_use_c2phc(617, a, b, c, 0);
...
int sweep_set_standard_start(int n, double *c) {
  ...
  fail = _ada_use_c2phc(618, ptos, &n, c, 0);
...
int sweep_get_standard_start(int n, double *c) {
  ...
  fail = _ada_use_c2phc(619, ptos, &n, c, 0);
...
int sweep_standard_complex_run(int gchoice, double *regamma, double *imgamma) {
  ...
  fail = _ada_use_c2phc(620, pg, b, c, 0);
...
int sweep_dobldobl_complex_run(int gchoice, double *regamma, double *imgamma) {
  ...
  if (gchoice == 2) {
    c[0] = regamma[0];
    c[1] = regamma[1]; /* regamma is a double double */
    c[2] = imgamma[0];
    c[3] = imgamma[1]; /* imgamma is a double double */
  }
  fail = _ada_use_c2phc(620, pg, b, c, 0);
...
int sweep_quaddobl_complex_run(int gchoice, double *regamma, double *imgamma) {
  ...
  if (gchoice == 2) {
    c[0] = regamma[0];
    c[1] = regamma[1]; /* regamma is a quad double */
    c[2] = regamma[2];
    c[3] = regamma[3];
    c[0] = imgamma[0];
    c[1] = imgamma[1]; /* imgamma is a quad double */
    c[2] = imgamma[2];
    c[3] = imgamma[3];
  }
  fail = _ada_use_c2phc(620, pg, b, c, 0);
...
int sweep_standard_real_run(void) {
  ...
  fail = _ada_use_c2phc(621, &precision, b, c, 0);
