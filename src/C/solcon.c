...
int solcon_read_standard_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(30, a, b, c, 0);
  return fail;
}
...
int solcon_read_standard_solutions_from_file(int nc, char *filename) {
  ...
  fail = _ada_use_c2phc(916, &nc, b, c, 0);
...
int solcon_read_dobldobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(340, a, b, c, 0);
  return fail;
}
...
int solcon_read_dobldobl_solutions_from_file(int nc, char *filename) {
  ...
  fail = _ada_use_c2phc(917, &nc, b, c, 0);
...
int solcon_read_quaddobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(390, a, b, c, 0);
  return fail;
}
...
int solcon_read_quaddobl_solutions_from_file(int nc, char *filename) {
  ...
  fail = _ada_use_c2phc(918, &nc, b, c, 0);
...
int solcon_read_multprec_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(450, a, b, c, 0);
  return fail;
}
...
int solcon_write_standard_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(31, a, b, c, 0);
  return fail;
}
...
int solcon_write_dobldobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(341, a, b, c, 0);
  return fail;
}
...
int solcon_write_quaddobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(391, a, b, c, 0);
  return fail;
}
...
int solcon_write_multprec_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(451, a, b, c, 0);
  return fail;
}
...
int solcon_number_of_standard_solutions(int *length) {
  int *a, fail;
  double *c;
  fail = _ada_use_c2phc(32, a, length, c, 0);
  return fail;
}
...
int solcon_number_of_dobldobl_solutions(int *length) {
  int *a, fail;
  double *c;
  fail = _ada_use_c2phc(342, a, length, c, 0);
  return fail;
}
...
int solcon_number_of_quaddobl_solutions(int *length) {
  int *a, fail;
  double *c;
  fail = _ada_use_c2phc(392, a, length, c, 0);
  return fail;
}
...
int solcon_number_of_multprec_solutions(int *length) {
  int *a, fail;
  double *c;
  fail = _ada_use_c2phc(452, a, length, c, 0);
  return fail;
}
...
int solcon_dimension_of_standard_solutions(int *dimension) {
  int *a, fail;
  double *c;
  fail = _ada_use_c2phc(33, a, dimension, c, 0);
  return fail;
}
...
int solcon_dimension_of_dobldobl_solutions(int *dimension) {
  int *a, fail;
  double *c;
  fail = _ada_use_c2phc(343, a, dimension, c, 0);
  return fail;
}
...
int solcon_dimension_of_quaddobl_solutions(int *dimension) {
  int *a, fail;
  double *c;
  fail = _ada_use_c2phc(393, a, dimension, c, 0);
  return fail;
}
...
int solcon_retrieve_next_standard_initialize(void) {
  ...
  a = 0;
  fail = _ada_use_c2phc(276, &a, b, c, 0);
...
int solcon_retrieve_next_dobldobl_initialize(void) {
  ...
  a = 0;
  fail = _ada_use_c2phc(277, &a, b, c, 0);
...
int solcon_retrieve_next_quaddobl_initialize(void) {
  ...
  a = 0;
  fail = _ada_use_c2phc(278, &a, b, c, 0);
...
int solcon_retrieve_next_multprec_initialize(void) {
  ...
  a = 0;
  fail = _ada_use_c2phc(279, &a, b, c, 0);

  return fail;
}

int solcon_retrieve_next_standard_solution(int n, int *k, int *m, double *sol) {
  int fail;
  *k = n;
  fail = _ada_use_c2phc(276, k, m, sol, 0);
  return fail;
}

int solcon_retrieve_next_dobldobl_solution(int n, int *k, int *m, double *sol) {
  int fail;
  *k = n;
  fail = _ada_use_c2phc(277, k, m, sol, 0);
  return fail;
}

int solcon_retrieve_next_quaddobl_solution(int n, int *k, int *m, double *sol) {
  int fail;
  *k = n;
  fail = _ada_use_c2phc(278, k, m, sol, 0);
  return fail;
}
...
int solcon_move_current_standard_to_next(int *cursor) {
  ...
  fail = _ada_use_c2phc(454, cursor, b, c, 0);
...
int solcon_move_current_dobldobl_to_next(int *cursor) {
  ...
  fail = _ada_use_c2phc(455, cursor, b, c, 0);
...
int solcon_move_current_quaddobl_to_next(int *cursor) {
  ...
  fail = _ada_use_c2phc(456, cursor, b, c, 0);
...
int solcon_move_current_multprec_to_next(int *cursor) {
  ...
  fail = _ada_use_c2phc(458, cursor, b, c, 0);
...
int solcon_length_current_standard_solution_string(int *cursor, int *n) {
  ...
  fail = _ada_use_c2phc(525, cursor, n, c, 0);
...
int solcon_length_current_dobldobl_solution_string(int *cursor, int *n) {
  ...
  fail = _ada_use_c2phc(526, cursor, n, c, 0);
...
int solcon_length_current_quaddobl_solution_string(int *cursor, int *n) {
  ...
  fail = _ada_use_c2phc(527, cursor, n, c, 0);
...
int solcon_length_current_multprec_solution_string(int *cursor, int *n) {
  ...
  fail = _ada_use_c2phc(528, cursor, n, c, 0);
...
int solcon_write_current_standard_solution_string(int *k, int n, char *s) {
  ...
  *k = n;
  fail = _ada_use_c2phc(533, k, b, c, 0);
  if (*k != 0) {
    for (i = 0; i < n; i++)
      s[i] = b[i];
    s[n] = '\0';
...
int solcon_write_current_dobldobl_solution_string(int *k, int n, char *s) {
  ...
  *k = n;
  fail = _ada_use_c2phc(534, k, b, c, 0);
  if (*k != 0) {
    for (i = 0; i < n; i++)
      s[i] = b[i];
    s[n] = '\0';
...
int solcon_write_current_quaddobl_solution_string(int *k, int n, char *s) {
  ...
  *k = n;
  fail = _ada_use_c2phc(535, k, b, c, 0);
  if (*k != 0) {
    for (i = 0; i < n; i++)
      s[i] = b[i];
    s[n] = '\0';
...
int solcon_replace_standard_solution(int n, int k, int m, double *sol) {
  ...
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(35, &k, b, sol, 0);
  return fail;
}
...
int solcon_replace_dobldobl_solution(int n, int k, int m, double *sol) {
  ...
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(345, &k, b, sol, 0);
  return fail;
}
...
int solcon_replace_quaddobl_solution(int n, int k, int m, double *sol) {
  ...
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(395, &k, b, sol, 0);
  return fail;
}
...
int solcon_append_standard_solution(int n, int m, double *sol) {
  ...
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(36, a, b, sol, 0);
  return fail;
}
...
int solcon_append_dobldobl_solution(int n, int m, double *sol) {
  ...
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(346, a, b, sol, 0);
  return fail;
}
...
int solcon_append_quaddobl_solution(int n, int m, double *sol) {
  ...
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(396, a, b, sol, 0);
  return fail;
}
...
int solcon_clear_standard_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(37, a, b, c, 0);
  return fail;
}
...
int solcon_clear_dobldobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(347, a, b, c, 0);
  return fail;
}
...
int solcon_clear_quaddobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(397, a, b, c, 0);
  return fail;
}
...
int solcon_clear_multprec_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(457, a, b, c, 0);
  return fail;
}
...
int solcon_open_solution_input_file(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(130, a, b, c, 0);
  return fail;
}
...
int solcon_create_solution_output_file(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(131, a, b, c, 0);
  return fail;
}
...
int solcon_scan_solution_banner(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(132, a, b, c, 0);
  return fail;
}
...
int solcon_write_solution_banner_to_defined_output_file(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(139, a, b, c, 0);
  return fail;
}
...
int solcon_read_solution_dimensions(int *len, int *dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(133, len, dim, c, 0);
  return fail;
}
...
int solcon_write_solution_dimensions(int len, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(134, &len, &dim, c, 0);
  return fail;
}

int solcon_write_solution_dimensions_to_defined_output_file(int len, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(140, &len, &dim, c, 0);
  return fail;
}

int solcon_compute_total_degree_solution(int n, int i, int *m, double *sol) {
  int fail, a[2];

  a[0] = n;
  a[1] = i;

  fail = _ada_use_c2phc(142, a, m, sol, 0);

  return fail;
}

int solcon_next_linear_product_solution(int n, int *i, int *m, double *sol) {
  int fail, a[2];

  a[0] = n, a[1] = *i;

  fail = _ada_use_c2phc(143, a, m, sol, 0);
...
int solcon_get_linear_product_solution(int n, int i, int *m, double *sol) {
  int fail, a[2];

  a[0] = n, a[1] = i;

  fail = _ada_use_c2phc(144, a, m, sol, 0);
...
int solcon_read_next_solution(int n, int *m, double *sol) {
  int fail;
  fail = _ada_use_c2phc(135, &n, m, sol, 0);
  return fail;
}
...
int solcon_read_next_witness_point(int k, int n, int *m, double *sol) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(145, a, m, sol, 0);
  return fail;
}

int solcon_extrinsic_product(int a, int b, int n1, int n2, double *s1,
                             double *s2, int pn, double *ps) {
  int i, inds1;

  ps[0] = 0.0;
  ps[1] = 0.0;

  for (i = 2; i < 2 * (n1 - a) + 2; i++)
    ps[i] = s1[i];

  inds1 = 2 * (n1 - a);
  for (i = 2; i < 2 * (n2 - b) + 2; i++)
    ps[inds1 + i] = s2[i];
...
int solcon_reset_input_file(int k, int *d, int *n) {
  ...
  fail = _ada_use_c2phc(167, &k, b, c, 0);
  *d = b[0];
  *n = b[1];
...
int get_next_start_product(int *i, int *j, int monitor, int n1, int n2,
                           int dim1, int dim2, int deg1, int deg2, int extcd,
...
int solcon_write_next_solution(int *k, int n, int m, double *sol) {
  ...
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(136, k, b, sol, 0);
  return fail;
}

int solcon_write_next_solution_to_defined_output_file(int *k, int n, int m,
                                                      double *sol) {
  int b[2], fail;
  b[0] = n;
  b[1] = m;
  fail = _ada_use_c2phc(141, k, b, sol, 0);
  return fail;
}
...
int solcon_close_solution_input_file(int k) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(137, &k, b, c, 0);
  return fail;
}
...
int solcon_close_solution_output_file(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(138, a, b, c, 0);
  return fail;
}
...
int solcon_length_standard_solution_string(int k, int *n) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(200, &k, n, c, 0);
  return fail;
}
...
int solcon_length_dobldobl_solution_string(int k, int *n) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(370, &k, n, c, 0);
  return fail;
}
...
int solcon_length_quaddobl_solution_string(int k, int *n) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(420, &k, n, c, 0);
  return fail;
}
...
int solcon_length_multprec_solution_string(int k, int *n) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(480, &k, n, c, 0);
  return fail;
}
...
int solcon_write_standard_solution_string(int k, int n, char *s) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(201, a, b, c, 0);
  for (i = 0; i < n; i++)
    s[i] = b[i];
  s[n] = '\0';
  return fail;
...
int solcon_write_dobldobl_solution_string(int k, int n, char *s) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(371, a, b, c, 0);
  for (i = 0; i < n; i++)
    s[i] = b[i];
  s[n] = '\0';
  return fail;
...
int solcon_write_quaddobl_solution_string(int k, int n, char *s) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(421, a, b, c, 0);
  for (i = 0; i < n; i++)
    s[i] = b[i];
  s[n] = '\0';
  return fail;
...
int solcon_write_multprec_solution_string(int k, int n, char *s) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(481, a, b, c, 0);
  for (i = 0; i < n; i++)
    s[i] = b[i];
  s[n] = '\0';
  return fail;
...
int solcon_length_solution_intro(int k, int *n) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(202, &k, n, c, 0);
  return fail;
}
...
int solcon_write_solution_intro(int k, int n, char *s) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(203, a, b, c, 0);
  for (i = 0; i < n; i++)
    s[i] = b[i];
  s[n] = '\0';
  return fail;
...
int solcon_length_solution_vector(int k, int *n) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(204, &k, n, c, 0);
  return fail;
}
...
int solcon_write_solution_vector(int k, int n, char *s) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(205, a, b, c, 0);
  for (i = 0; i < n; i++)
    s[i] = b[i];
  s[n] = '\0';
  return fail;
...
int solcon_length_solution_diagnostics(int k, int *n) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(206, &k, n, c, 0);
  return fail;
}
...
int solcon_write_solution_diagnostics(int k, int n, char *s) {
  ...
  a[0] = k;
  a[1] = n;
  fail = _ada_use_c2phc(207, a, b, c, 0);
  for (i = 0; i < n; i++)
    s[i] = b[i];
  s[n] = '\0';
  return fail;
...
int solcon_append_standard_solution_string(int nv, int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = s[i];
  fail = _ada_use_c2phc(208, a, b, c, 0);
  return fail;
}
...
int solcon_append_dobldobl_solution_string(int nv, int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = s[i];
  fail = _ada_use_c2phc(378, a, b, c, 0);
  return fail;
}
...
int solcon_append_quaddobl_solution_string(int nv, int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = s[i];
  fail = _ada_use_c2phc(428, a, b, c, 0);
  return fail;
}
...
int solcon_append_multprec_solution_string(int nv, int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = s[i];
  fail = _ada_use_c2phc(488, a, b, c, 0);
  return fail;
}
...
int solcon_replace_solution_string(int k, int nv, int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = s[i];
  fail = _ada_use_c2phc(209, a, b, c, 0);
  return fail;
}
...
int solcon_standard_drop_coordinate_by_index(int k) {
  int fail, *b;
  double *c;
  fail = _ada_use_c2phc(38, &k, b, c, 0);
  return fail;
}
...
int solcon_standard_drop_coordinate_by_name(int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = (int)s[i];
  fail = _ada_use_c2phc(146, &nc, b, c, 0);
  return fail;
}
...
int solcon_dobldobl_drop_coordinate_by_index(int k) {
  int fail, *b;
  double *c;
  fail = _ada_use_c2phc(348, &k, b, c, 0);
  return fail;
}
...
int solcon_dobldobl_drop_coordinate_by_name(int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = (int)s[i];
  fail = _ada_use_c2phc(349, &nc, b, c, 0);
  return fail;
}
...
int solcon_quaddobl_drop_coordinate_by_index(int k) {
  int fail, *b;
  double *c;
  fail = _ada_use_c2phc(398, &k, b, c, 0);
  return fail;
}
...
int solcon_quaddobl_drop_coordinate_by_name(int nc, char *s) {
  ...
  for (i = 0; i < nc; i++)
    b[i] = (int)s[i];
  fail = _ada_use_c2phc(399, &nc, b, c, 0);
  return fail;
}
...
int solcon_standard_set_continuation_parameter(void) {
  ...
  fail = _ada_use_c2phc(875, a, b, c, 0);
...
int solcon_dobldobl_set_continuation_parameter(void) {
  ...
  fail = _ada_use_c2phc(876, a, b, c, 0);
...
int solcon_quaddobl_set_continuation_parameter(void) {
  ...
  fail = _ada_use_c2phc(877, a, b, c, 0);
...
int solcon_standard_one_homogenization(void) {
  ...
  fail = _ada_use_c2phc(894, a, b, c, 0);
...
int solcon_dobldobl_one_homogenization(void) {
  ...
  fail = _ada_use_c2phc(895, a, b, c, 0);
...
int solcon_quaddobl_one_homogenization(void) {
  ...
  fail = _ada_use_c2phc(896, a, b, c, 0);
...
int solcon_standard_multi_homogenization(int m) {
  ...
  fail = _ada_use_c2phc(910, &m, &b, &c, 0);
...
int solcon_dobldobl_multi_homogenization(int m) {
  ...
  fail = _ada_use_c2phc(911, &m, &b, &c, 0);
...
int solcon_quaddobl_multi_homogenization(int m) {
  ...
  fail = _ada_use_c2phc(912, &m, &b, &c, 0);
...
int solcon_standard_one_affinization(void) {
  ...
  fail = _ada_use_c2phc(898, a, b, c, 0);
...
int solcon_dobldobl_one_affinization(void) {
  ...
  fail = _ada_use_c2phc(899, a, b, c, 0);
...
int solcon_quaddobl_one_affinization(void) {
  ...
  fail = _ada_use_c2phc(900, a, b, c, 0);
...
int solcon_standard_multi_affinization(int n, int m, int *z) {
  ...
  fail = _ada_use_c2phc(913, pars, z, &c, 0);
...
int solcon_dobldobl_multi_affinization(int n, int m, int *z) {
  ...
  fail = _ada_use_c2phc(914, pars, z, &c, 0);
...
int solcon_quaddobl_multi_affinization(int n, int m, int *z) {
  ...
  fail = _ada_use_c2phc(915, pars, z, &c, 0);
