...
int embed_system(int d, int precision, int vrblvl) {
  ...
  if (precision == 0)
    fail = embed_standard_system(d, vrblvl);
  if (precision == 1)
    fail = embed_dobldobl_system(d, vrblvl);
  if (precision == 2)
    fail = embed_quaddobl_system(d, vrblvl);
...
int embed_standard_system(int d, int vrblvl) {
  ...
  fail = _ada_use_c2phc(66, &d, b, c, vrblvl);
  return fail;
}
...
int embed_dobldobl_system(int d, int vrblvl) {
  ...
  fail = _ada_use_c2phc(129, &d, b, c, vrblvl);
  return fail;
}
...
int embed_quaddobl_system(int d, int vrblvl) {
  ...
  fail = _ada_use_c2phc(260, &d, b, c, vrblvl);
  return fail;
}
...
int embed_standard_Laurent_system(int d, int vrblvl) {
  ...
  fail = _ada_use_c2phc(625, &d, b, c, vrblvl);
  return fail;
}
...
int embed_dobldobl_Laurent_system(int d, int vrblvl) {
  ...
  fail = _ada_use_c2phc(626, &d, b, c, vrblvl);
  return fail;
}
...
int embed_quaddobl_Laurent_system(int d, int vrblvl) {
  ...
  fail = _ada_use_c2phc(627, &d, b, c, vrblvl);
  return fail;
}
...
int read_witness_set(int *n, int *dim, int *deg) {
  ...
  fail = _ada_use_c2phc(41, n, d, c, 0); /* read the witness set */
  *dim = d[0];
  *deg = d[1];
  if (verbose > 0)
    printf("The ambient dimension is %d.\n", *n);
  if (verbose > 0)
    printf("The dimension of the solution set is %d.\n", d[0]);
  if (verbose > 0)
    printf("The degree of the solution set is %d.\n", d[1]);
  if (verbose > 1) {
...
int read_dobldobl_witness_set(int *n, int *dim, int *deg) {
  ...
  fail = _ada_use_c2phc(631, n, d, c, 0); /* read the witness set */
  *dim = d[0];
  *deg = d[1];
  if (verbose > 0)
    printf("The ambient dimension is %d.\n", *n);
...
int read_quaddobl_witness_set(int *n, int *dim, int *deg) {
  ...
  fail = _ada_use_c2phc(661, n, d, c, 0); /* read the witness set */
  *dim = d[0];
  *deg = d[1];
  if (verbose > 0)
    printf("The ambient dimension is %d.\n", *n);
...
int read_witness_set_from_file(int m, char *s, int *n, int *dim, int *deg) {
  ...
  *n = m;
  fail = _ada_use_c2phc(64, n, b, c, 0);
  *dim = b[0];
  *deg = b[1];
...
int read_dobldobl_witness_set_from_file(int m, char *s, int *n, int *dim,
  ...
  *n = m;
  fail = _ada_use_c2phc(654, n, b, c, 0);
  *dim = b[0];
  *deg = b[1];
...
int read_quaddobl_witness_set_from_file(int m, char *s, int *n, int *dim,
  ...
  *n = m;
  fail = _ada_use_c2phc(684, n, b, c, 0);
  *dim = b[0];
  *deg = b[1];
...
int read_standard_Laurent_witness_set(int *n, int *dim, int *deg) {
  ...
  fail = _ada_use_c2phc(798, n, d, c, 0); /* read the witness set */
  *dim = d[0];
  *deg = d[1];
  if (verbose > 0)
    printf("The ambient dimension is %d.\n", *n);
...
int read_dobldobl_Laurent_witness_set(int *n, int *dim, int *deg) {
  ...
  fail = _ada_use_c2phc(799, n, d, c, 0); /* read the witness set */
  *dim = d[0];
  *deg = d[1];
  if (verbose > 0)
    printf("The ambient dimension is %d.\n", *n);
...
int read_quaddobl_Laurent_witness_set(int *n, int *dim, int *deg) {
  ...
  fail = _ada_use_c2phc(800, n, d, c, 0); /* read the witness set */
  *dim = d[0];
  *deg = d[1];
  if (verbose > 0)
    printf("The ambient dimension is %d.\n", *n);
...
int read_standard_Laurent_witness_set_from_file(int m, char *s, int *n,
  ...
  *n = m;
  fail = _ada_use_c2phc(801, n, b, c, 0);
  *dim = b[0];
  *deg = b[1];
...
int read_dobldobl_Laurent_witness_set_from_file(int m, char *s, int *n,
  ...
  *n = m;
  fail = _ada_use_c2phc(802, n, b, c, 0);
  *dim = b[0];
  *deg = b[1];
...
int read_quaddobl_Laurent_witness_set_from_file(int m, char *s, int *n,
  ...
  *n = m;
  fail = _ada_use_c2phc(803, n, b, c, 0);
  *dim = b[0];
  *deg = b[1];
...
int write_witness_set_to_file(int m, char *s) {
  ...
  fail = _ada_use_c2phc(65, &m, b, c, 0);
...
int write_dobldobl_witness_set_to_file(int m, char *s) {
  ...
  fail = _ada_use_c2phc(655, &m, b, c, 0);
...
int write_quaddobl_witness_set_to_file(int m, char *s) {
  ...
  fail = _ada_use_c2phc(685, &m, b, c, 0);
...
int read_a_witness_set(int k, int *n, int *dim, int *deg) {
  ...
  *n = k;
  fail = _ada_use_c2phc(166, n, d, c, 0);
  *dim = d[0];
  *deg = d[1];
...
int standard_witness_set_to_system_container(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(47, a, b, c, 0); /* copy system to container */
  return fail;
}
...
int dobldobl_witness_set_to_system_container(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(637, a, b, c, 0); /* copy system to container */
  return fail;
}
...
int quaddobl_witness_set_to_system_container(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(667, a, b, c, 0); /* copy system to container */
  return fail;
}
...
int standard_witness_set_to_Laurent_system_container(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(807, a, b, c, 0); /* copy system to container */
  return fail;
}
...
int dobldobl_witness_set_to_Laurent_system_container(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(808, a, b, c, 0); /* copy system to container */
  return fail;
}
...
int quaddobl_witness_set_to_Laurent_system_container(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(809, a, b, c, 0); /* copy system to container */
  return fail;
}
...
int swap_symbols_for_standard_witness_set(int nvr, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(816, &nvr, &dim, c, 0);
  return fail;
}
...
int swap_symbols_for_dobldobl_witness_set(int nvr, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(817, &nvr, &dim, c, 0);
  return fail;
}
...
int swap_symbols_for_quaddobl_witness_set(int nvr, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(818, &nvr, &dim, c, 0);
  return fail;
}
...
int swap_symbols_for_standard_Laurent_witness_set(int nvr, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(819, &nvr, &dim, c, 0);
  return fail;
}
...
int swap_symbols_for_dobldobl_Laurent_witness_set(int nvr, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(820, &nvr, &dim, c, 0);
  return fail;
}
...
int swap_symbols_for_quaddobl_Laurent_witness_set(int nvr, int dim) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(821, &nvr, &dim, c, 0);
  return fail;
}
...
int create_cascade_homotopy(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(164, a, b, c, 0);
  return fail;
}
...
int create_dobldobl_cascade_homotopy(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(178, a, b, c, 0);
  return fail;
}
...
int create_quaddobl_cascade_homotopy(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(188, a, b, c, 0);
  return fail;
}
...
int create_standard_Laurent_cascade_homotopy(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(789, a, b, c, 0);
  return fail;
}
...
int create_dobldobl_Laurent_cascade_homotopy(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(790, a, b, c, 0);
  return fail;
}
...
int create_quaddobl_Laurent_cascade_homotopy(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(791, a, b, c, 0);
  return fail;
}
...
int standard_diagonal_homotopy(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(165, &a, &b, c, 0);
  return fail;
}
...
int dobldobl_diagonal_homotopy(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(289, &a, &b, c, 0);
  return fail;
}
...
int quaddobl_diagonal_homotopy(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(290, &a, &b, c, 0);
  return fail;
}
...
int standard_diagonal_Laurent_homotopy(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(810, &a, &b, c, 0);
  return fail;
}
...
int dobldobl_diagonal_Laurent_homotopy(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(811, &a, &b, c, 0);
  return fail;
}
...
int quaddobl_diagonal_Laurent_homotopy(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(812, &a, &b, c, 0);
  return fail;
}
...
int standard_diagonal_cascade_solutions(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(271, &a, &b, c, 0);
  return fail;
}
...
int dobldobl_diagonal_cascade_solutions(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(297, &a, &b, c, 0);
  return fail;
}
...
int quaddobl_diagonal_cascade_solutions(int a, int b) {
  int fail;
  double *c;
  fail = _ada_use_c2phc(298, &a, &b, c, 0);
  return fail;
}
...
int extrinsic_top_diagonal_dimension(int n1, int n2, int a, int b, int *d) {
  ...
  fail = _ada_use_c2phc(168, alpha, beta, c, 0);
...
int hypersurface_witness_set(int k, int n, char *s) {
  ...
  fail = _ada_use_c2phc(169, a, b, c, 0);
...
int standard_witset_of_hypersurface(int nv, int nc, char *p) {
  ...
  fail = _ada_use_c2phc(270, a, b, c, 0);
...
int dobldobl_witset_of_hypersurface(int nv, int nc, char *p) {
  ...
  fail = _ada_use_c2phc(259, a, b, c, 0);
...
int quaddobl_witset_of_hypersurface(int nv, int nc, char *p) {
  ...
  fail = _ada_use_c2phc(269, a, b, c, 0);
...
int standard_witset_of_Laurent_hypersurface(int nv, int nc, char *p) {
  ...
  fail = _ada_use_c2phc(813, a, b, c, 0);
...
int dobldobl_witset_of_Laurent_hypersurface(int nv, int nc, char *p) {
  ...
  fail = _ada_use_c2phc(814, a, b, c, 0);
...
int quaddobl_witset_of_Laurent_hypersurface(int nv, int nc, char *p) {
  ...
  fail = _ada_use_c2phc(815, a, b, c, 0);
...
int diagonal_symbols_doubler(int n, int d, int nc, char *s) {
  ...
  fail = _ada_use_c2phc(230, a, b, c, 0);
...
int standard_collapse_diagonal(int k, int d) {
  ...
  a[0] = k;
  a[1] = d;
  fail = _ada_use_c2phc(170, a, b, c, 0);
...
int dobldobl_collapse_diagonal(int k, int d) {
  ...
  a[0] = k;
  a[1] = d;
  fail = _ada_use_c2phc(299, a, b, c, 0);
...
int quaddobl_collapse_diagonal(int k, int d) {
  ...
  a[0] = k;
  a[1] = d;
  fail = _ada_use_c2phc(312, a, b, c, 0);
...
int remove_last_slack(int k) {
  ...
  fail = _ada_use_c2phc(171, &k, b, c, 0);
...
int set_standard_state_to_silent(void) {
  ...
  fail = _ada_use_c2phc(39, a, b, c, 0);
...
int set_dobldobl_state_to_silent(void) {
  ...
  fail = _ada_use_c2phc(658, a, b, c, 0);
...
int set_quaddobl_state_to_silent(void) {
  ...
  fail = _ada_use_c2phc(688, a, b, c, 0);
...
int set_standard_state_to_verbose(void) {
  ...
  fail = _ada_use_c2phc(630, a, b, c, 0);
...
int set_dobldobl_state_to_verbose(void) {
  ...
  fail = _ada_use_c2phc(660, a, b, c, 0);
...
int set_quaddobl_state_to_verbose(void) {
  ...
  fail = _ada_use_c2phc(690, a, b, c, 0);
...
int assign_labels(int n, int nbsols, int precision) {
  if (precision == 0)
    return standard_assign_labels(n, nbsols);
  if (precision == 1)
    return dobldobl_assign_labels(n, nbsols);
  if (precision == 2)
    return quaddobl_assign_labels(n, nbsols);
...
int initialize_standard_sampler(int dim) {
  ...
  fail = _ada_use_c2phc(42, &dim, b, c, 0); /* initialize sampler */
...
int initialize_dobldobl_sampler(int dim) {
  ...
  fail = _ada_use_c2phc(632, &dim, b, c, 0); /* initialize sampler */
...
int initialize_quaddobl_sampler(int dim) {
  ...
  fail = _ada_use_c2phc(662, &dim, b, c, 0); /* initialize sampler */
...
int initialize_standard_Laurent_sampler(int dim) {
  ...
  fail = _ada_use_c2phc(804, &dim, b, c, 0); /* initialize sampler */
...
int initialize_dobldobl_Laurent_sampler(int dim) {
  ...
  fail = _ada_use_c2phc(805, &dim, b, c, 0); /* initialize sampler */
...
int initialize_quaddobl_Laurent_sampler(int dim) {
  ...
  fail = _ada_use_c2phc(806, &dim, b, c, 0); /* initialize sampler */
...
int initialize_standard_monodromy(int n, int d, int k) {
  ...
  dk[0] = d;
  dk[1] = k;
  fail = _ada_use_c2phc(50, &n, dk, c, 0);
...
int initialize_dobldobl_monodromy(int n, int d, int k) {
  ...
  dk[0] = d;
  dk[1] = k;
  fail = _ada_use_c2phc(640, &n, dk, c, 0);
...
int initialize_quaddobl_monodromy(int n, int d, int k) {
  ...
  dk[0] = d;
  dk[1] = k;
  fail = _ada_use_c2phc(670, &n, dk, c, 0);
...
int standard_trace_grid_diagnostics(double *err, double *dis) {
  ...
  fail = _ada_use_c2phc(56, a, b, c, 0);
  *err = c[0];
  *dis = c[1];
...
int dobldobl_trace_grid_diagnostics(double *err, double *dis) {
  ...
  fail = _ada_use_c2phc(646, a, b, c, 0);
  *err = c[0];
  *dis = c[1];
...
int quaddobl_trace_grid_diagnostics(double *err, double *dis) {
  ...
  fail = _ada_use_c2phc(676, a, b, c, 0);
  *err = c[0];
  *dis = c[1];
...
int random_standard_complex(double *re, double *im) {
  ...
  fail = _ada_use_c2phc(280, a, b, c, 0);
  *re = c[0];
  *im = c[1];
...
int random_dobldobl_complex(double *re, double *im) {
  ...
  fail = _ada_use_c2phc(659, a, b, c, 0);
  re[0] = c[0];
  re[1] = c[1];
  im[0] = c[2];
  im[1] = c[3];
...
int random_quaddobl_complex(double *re, double *im) {
  ...
  fail = _ada_use_c2phc(689, a, b, c, 0);
  re[0] = c[0];
  re[1] = c[1];
  re[2] = c[2];
  re[3] = c[3];
...
int store_standard_gamma(int n, double *re_gamma, double *im_gamma) {
  ...
  for (i = 0; i < n; i++) {
    r[0] = re_gamma[i];
    r[1] = im_gamma[i];
    fail = _ada_use_c2phc(44, &i, b, r, 0); /* store gamma */
  }
...
int store_dobldobl_gamma(int n, double *re_gamma, double *im_gamma) {
  ...
  for (i = 0; i < n; i++) {
    ...
    r[2] = im_gamma[2 * i];
    r[3] = im_gamma[2 * i + 1];
    fail = _ada_use_c2phc(634, &i, b, r, 0); /* store gamma */
  }
...
int store_quaddobl_gamma(int n, double *re_gamma, double *im_gamma) {
  ...
  for (i = 0; i < n; i++) {
    ...
    r[6] = im_gamma[4 * i + 2];
    r[7] = im_gamma[4 * i + 3];
    fail = _ada_use_c2phc(664, &i, b, r, 0); /* store gamma */
  }
...
int initialize_hyperplane_sections(int m) {
  int *b, fail;
  double *c;
  fail = _ada_use_c2phc(59, &m, b, c, 0);
  return fail;
}
...
int store_new_hyperplane_sections(int m, int k, int n, double *c) {
  ...
  a[1] = k;
  a[2] = n;
  fail = _ada_use_c2phc(60, a, b, c, 0);
  return fail;
}
...
int retrieve_hyperplane_sections(int m, int k, int n, int i, double *c) {
  ...
  a[1] = k;
  a[2] = n;
  fail = _ada_use_c2phc(61, a, &i, c, 0);
  return fail;
}
...
int set_target_hyperplane_sections(int i) {
  int *b, fail;
  double *c;
  fail = _ada_use_c2phc(62, &i, b, c, 0);
  return fail;
}
...
int new_standard_slices(int k, int n) {
  ...
  for (i = 0; i < k; i++)
    for (j = 0; j < n + 1; j++) {
      ...
      fail = _ada_use_c2phc(43, &i, &j, r, 0); /* assign coefficient */
    }
...
int new_dobldobl_slices(int k, int n) {
  ...
  for (i = 0; i < k; i++)
    for (j = 0; j < n + 1; j++) {
      ...
      fail = _ada_use_c2phc(633, &i, &j, r, 0); /* assign coefficient */
    }
...
int new_quaddobl_slices(int k, int n) {
  ...
  for (i = 0; i < k; i++)
    for (j = 0; j < n + 1; j++) {
      ...
      fail = _ada_use_c2phc(663, &i, &j, r, 0); /* assign coefficient */
    }
...
int swap_standard_slices(void) {
  double *c;
  int fail, *a, *b;
  fail = _ada_use_c2phc(46, a, b, c, 0); /* swap start with new slices */
  return fail;
}
...
int swap_dobldobl_slices(void) {
  double *c;
  int fail, *a, *b;
  fail = _ada_use_c2phc(636, a, b, c, 0); /* swap start with new slices */
  return fail;
}
...
int swap_quaddobl_slices(void) {
  double *c;
  int fail, *a, *b;
  fail = _ada_use_c2phc(666, a, b, c, 0); /* swap start with new slices */
  return fail;
}
...
int store_standard_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(51, a, b, c, 0); /* standard sols to permutations */
  return fail;
}
...
int store_dobldobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(641, a, b, c, 0); /* dobldobl sols to permutations */
  return fail;
}
...
int store_quaddobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(671, a, b, c, 0); /* quaddobl sols to permutations */
  return fail;
}
...
int restore_standard_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(48, a, b, c, 0); /* first solutions to container */
  return fail;
}
...
int restore_dobldobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(638, a, b, c, 0); /* first dobldobl sols to container */
  return fail;
}
...
int restore_quaddobl_solutions(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(668, a, b, c, 0); /* first quaddobl sols to container */
  return fail;
}
...
int retrieve_solutions_on_grid(int i) {
  int *b, fail;
  double *c;
  fail = _ada_use_c2phc(49, &i, b, c, 0);
  return fail;
}
...
int in_slice(int label, int slice, int *position) {
  ...
  a[0] = label;
  a[1] = slice;
  fail = _ada_use_c2phc(58, a, position, c, 0);
...
int standard_sample_to_new_slices(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(45, a, b, c, 0); /* track paths */
  return fail;
}
...
int dobldobl_sample_to_new_slices(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(635, a, b, c, 0); /* track paths */
  return fail;
}
...
int quaddobl_sample_to_new_slices(void) {
  int *a, *b, fail;
  double *c;
  fail = _ada_use_c2phc(665, a, b, c, 0); /* track paths */
  return fail;
}
...
int standard_sample_loop(int start_slice, int target_slice, int start_label,
  ...
  *target_label = start_label;
  fail = _ada_use_c2phc(63, a, target_label, c, 0); /* calls sample loop */
...
int dobldobl_sample_loop(int start_slice, int target_slice, int start_label,
  ...
  a[1] = target_slice;
  *target_label = start_label;
  fail = _ada_use_c2phc(653, a, target_label, c, 0); /* calls sample loop */
...
int quaddobl_sample_loop(int start_slice, int target_slice, int start_label,
  ...
  a[1] = target_slice;
  *target_label = start_label;
  fail = _ada_use_c2phc(683, a, target_label, c, 0); /* calls sample loop */
...
int number_of_standard_factors(int *nf) {
  ...
  fail = _ada_use_c2phc(68, nf, b, c, 0);
...
int number_of_dobldobl_factors(int *nf) {
  ...
  fail = _ada_use_c2phc(656, nf, b, c, 0);
...
int number_of_quaddobl_factors(int *nf) {
  ...
  fail = _ada_use_c2phc(686, nf, b, c, 0);
...
int witness_points_of_standard_factor(int k, int *d, int *w) {
  ...
  *d = k;
  fail = _ada_use_c2phc(69, d, w, c, 0);
...
int witness_points_of_dobldobl_factor(int k, int *d, int *w) {
  ...
  *d = k;
  fail = _ada_use_c2phc(657, d, w, c, 0);
...
int witness_points_of_quaddobl_factor(int k, int *d, int *w) {
  ...
  *d = k;
  fail = _ada_use_c2phc(687, d, w, c, 0);
...
int permutation_after_standard_loop(int d, int *permutation) {
  ...
  fail = _ada_use_c2phc(52, a, permutation, c, 0); /* compute permutation */
...
int permutation_after_dobldobl_loop(int d, int *permutation) {
  ...
  fail = _ada_use_c2phc(642, a, permutation, c, 0); /* compute permutation */
...
int permutation_after_quaddobl_loop(int d, int *permutation) {
  ...
  fail = _ada_use_c2phc(672, a, permutation, c, 0); /* compute permutation */
...
int update_standard_decomposition(int d, int *permutation, int *nf, int *done) {
  ...
  nf[0] = d;
  nf[1] = 0;
  fail = _ada_use_c2phc(53, nf, permutation, c, 0);
  fail = _ada_use_c2phc(55, done, b, c, 0);
...
int update_dobldobl_decomposition(int d, int *permutation, int *nf, int *done) {
  ...
  nf[0] = d;
  nf[1] = 0;
  fail = _ada_use_c2phc(643, nf, permutation, c, 0);
  fail = _ada_use_c2phc(645, done, b, c, 0);
...
int update_quaddobl_decomposition(int d, int *permutation, int *nf, int *done) {
  ...
  nf[0] = d;
  nf[1] = 0;
  fail = _ada_use_c2phc(673, nf, permutation, c, 0);
  fail = _ada_use_c2phc(675, done, b, c, 0);
...
int standard_monodromy_permutation(int d, int *done) {
  ...
  nf[0] = d;
  nf[1] = 0;
  fail = _ada_use_c2phc(53, nf, permutation, c, 0); /* update decomposition */
  if (verbose > 0)
    printf(" : %d -> %d\n", nf[0], nf[1]);
  fail = _ada_use_c2phc(55, done, b, c, 0); /* apply linear trace */
...
int dobldobl_monodromy_permutation(int d, int *done) {
  ...
  nf[0] = d;
  nf[1] = 0;
  fail = _ada_use_c2phc(643, nf, permutation, c, 0); /* update decomposition */
  if (verbose > 0)
    printf(" : %d -> %d\n", nf[0], nf[1]);
  fail = _ada_use_c2phc(645, done, b, c, 0); /* apply linear trace */
...
int quaddobl_monodromy_permutation(int d, int *done) {
  ...
  nf[0] = d;
  nf[1] = 0;
  fail = _ada_use_c2phc(673, nf, permutation, c, 0); /* update decomposition */
  if (verbose > 0)
    printf(" : %d -> %d\n", nf[0], nf[1]);
  fail = _ada_use_c2phc(675, done, b, c, 0); /* apply linear trace */
...
int standard_homotopy_membership_test(int vrb, int nvr, int dim, double restol,
  ...
  fail = _ada_use_c2phc(537, &vrb, dims, cffs, 0);
...
int dobldobl_homotopy_membership_test(int vrb, int nvr, int dim, double restol,
  ...
  fail = _ada_use_c2phc(538, &vrb, dims, cffs, 0);
...
int quaddobl_homotopy_membership_test(int vrb, int nvr, int dim, double restol,
  ...
  fail = _ada_use_c2phc(539, &vrb, dims, cffs, 0);
...
int standard_Laurent_homotopy_membership_test(int vrb, int nvr, int dim,
  ...
  fail = _ada_use_c2phc(795, &vrb, dims, cffs, 0);
...
int dobldobl_Laurent_homotopy_membership_test(int vrb, int nvr, int dim,
  ...
  fail = _ada_use_c2phc(796, &vrb, dims, cffs, 0);
...
int quaddobl_Laurent_homotopy_membership_test(int vrb, int nvr, int dim,
  ...
  fail = _ada_use_c2phc(797, &vrb, dims, cffs, 0);
...
int standard_homotopy_ismember(int vrb, int nvr, int dim, int nbc, char *tpt,
  ...
  fail = _ada_use_c2phc(822, dims, testsol, tols, 0);
...
int dobldobl_homotopy_ismember(int vrb, int nvr, int dim, int nbc, char *tpt,
  ...
  fail = _ada_use_c2phc(823, dims, testsol, tols, 0);
...
int quaddobl_homotopy_ismember(int vrb, int nvr, int dim, int nbc, char *tpt,
  ...
  fail = _ada_use_c2phc(824, dims, testsol, tols, 0);
...
int standard_Laurent_homotopy_ismember(int vrb, int nvr, int dim, int nbc,
  ...
  fail = _ada_use_c2phc(825, dims, testsol, tols, 0);
...
int dobldobl_Laurent_homotopy_ismember(int vrb, int nvr, int dim, int nbc,
  ...
  fail = _ada_use_c2phc(826, dims, testsol, tols, 0);
...
int quaddobl_Laurent_homotopy_ismember(int vrb, int nvr, int dim, int nbc,
  ...
  fail = _ada_use_c2phc(827, dims, testsol, tols, 0);
