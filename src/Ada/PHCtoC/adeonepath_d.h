/* This file adeonepath_d.h collects the prototypes to track one path
 * using algorithmic differentiation in double precision */

#ifndef __ADEONEPATH_D_H__
#define __ADEONEPATH_D_H__
...
extern "C" int adeonepath_d ( int verbose );
/*
 * DESCRIPTION :
