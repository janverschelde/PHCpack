/* This file gpumanypaths_d.h collects the prototypes to track many paths
 * with GPU acceleration in double precision. */

#ifndef __GPUMANYPATHS_D_H__
#define __GPUMANYPATHS_D_H__
