...
package Standard_LaurSys_Interface is

-- DESCRIPTION :
--   The functions below define the interface to the container of
--   Laurent polynomials in double precision.
...
--   was successful, otherwise the nonzero job code is returned.
  ...
  -- DESCRIPTION :
  --   Prompts the user for a Laurent polynomial system in double precision
  ...
  -- DESCRIPTION :
  --   Writes the Laurent polynomial system stored in double precision
  ...
  -- ON RETURN :
  --   a       the number of Laurent polynomials stored in double precision.
  ...
  -- DESCRIPTION :
  --   Initializes the number of Laurent polynomials in double precision
  ...
  -- DESCRIPTION :
  --   Returns a term of a Laurent polynomial stored in double precision.
  ...
  -- DESCRIPTION :
  --   Adds a term to a Laurent polynomial stored in double precision.
  ...
  --   stores the Laurent polynomial in double precision.
  ...
  --   a Laurent polynomial in double precision.
  ...
  --           Laurent polynomial in double precision with index a[0].
  ...
  -- DESCRIPTION :
  --   Clears all Laurent polynomials stored in double precision.
  --   The verbose level is given in vrblvl.
