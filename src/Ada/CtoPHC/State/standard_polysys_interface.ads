...
--   otherwise the nonzero job code is returned.
  ...
  -- DESCRIPTION :
  --   Drops a variable from the system stored in double precision.
  ...
  -- DESCRIPTION :
  --   Makes a random system with coefficients in double precision
  ...
  -- DESCRIPTION :
  --   Makes the system stored in double precision 1-homogeneous,
  ...
  -- DESCRIPTION :
  --   Makes the system stored in double precision multihomogeneous,
  --   eventually adding one random hyperplane.
  ...
  -- DESCRIPTION :
  --   Reads the target system in double precision 
  --   from file with the given name.
  --   No solutions are read.
