...
package Polynomial_Systems_Container is
...
-- CONSTRUCTORS :
  ...
  procedure Add_Term ( k : in natural; t : in Term );
  ...
  procedure Add_Poly ( k : in natural; p : in Poly );
...
-- SELECTORS :
  ...
  function Retrieve_Poly ( k : natural ) return Poly;
