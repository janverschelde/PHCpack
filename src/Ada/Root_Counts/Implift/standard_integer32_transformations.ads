...
package Standard_Integer32_Transformations is

-- DESCRIPTION :
--   This package implements monomial transformations on 32-bit exponents.
...
end Standard_Integer32_Transformations;
