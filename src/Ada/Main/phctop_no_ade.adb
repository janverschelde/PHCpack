...
with Option_Handlers_no_ade;

procedure phctop_no_ade is
  ...
  begin
    ...
    Option_Handlers_no_ade.Handle(args,sortopts,arg1,arg2,arg3);
  end Handle_Options;
  ...
  begin
    if argc = 0 then
      Option_Handlers_no_ade.Handle_no_Options("","");
    else -- argc > 0
      declare
