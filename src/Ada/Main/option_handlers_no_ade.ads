...
package Option_Handlers_no_ade is
...
--   This is the version without the Algorithmic Differentiation,
--   nor the QD library needed for the Path library.
