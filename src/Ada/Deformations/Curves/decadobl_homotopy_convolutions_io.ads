...
with DecaDobl_Complex_Solutions;         use DecaDobl_Complex_Solutions;
with DecaDobl_Speelpenning_Convolutions; use DecaDobl_Speelpenning_Convolutions;

package DecaDobl_Homotopy_Convolutions_io is

-- DESCRIPTION :
--   Provides a general interactive procedure to prompt the user to
--   define a homotopy respresented by convolution circuits,
--   and corresponding start solutions, in deca double precision.
  ...
  --   defined in deca double precision in DecaDobl_Homotopy.
