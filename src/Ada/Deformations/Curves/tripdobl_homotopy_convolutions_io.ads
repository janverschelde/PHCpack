...
with TripDobl_Speelpenning_Convolutions; use TripDobl_Speelpenning_Convolutions;

package TripDobl_Homotopy_Convolutions_io is

-- DESCRIPTION :
--   Provides a general interactive procedure to prompt the user to
--   define a homotopy respresented by convolution circuits,
--   and corresponding start solutions, in triple double precision.
  ...
  --   defined in triple double precision in TripDobl_Homotopy.
