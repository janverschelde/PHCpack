...
package body Homotopy_Pade_Approximants is
  ...
  begin
    Standard_Series_Newton(sol,nbequ,nbterms,nbiters,srv,eva);
  ...
  begin
    DoblDobl_Series_Newton(sol,nbequ,nbterms,nbiters,srv,eva);
  ...
  begin
    QuadDobl_Series_Newton(sol,nbequ,nbterms,nbiters,srv,eva);
