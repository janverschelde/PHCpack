...
package body QuadDobl_Fabry_on_Homotopy is
  ...
  begin
    if vrblvl > 0
     then put_line("-> in quaddobl_fabry_on_homotopy.Artificial_Setup ...");
    end if;
    new_line;
    ...
    if nbsols = 0 then
      ...
      if tofile then
        ...
        QuadDobl_System_and_Solutions_io.put
  ...
  begin
    if vrblvl > 0
     then put_line("-> in quaddobl_fabry_on_homotopy.Natural_Setup ...");
    end if;
    new_line;
  ...
  begin
    if vrblvl > 0
     then put_line("-> in quaddobl_fabry_on_homotopy.Main ...");
    end if;
    new_line;
