...
with HexaDobl_Complex_Solutions;         use HexaDobl_Complex_Solutions;
with HexaDobl_Speelpenning_Convolutions; use HexaDobl_Speelpenning_Convolutions;

package HexaDobl_Homotopy_Convolutions_io is

-- DESCRIPTION :
--   Provides a general interactive procedure to prompt the user to
--   define a homotopy respresented by convolution circuits,
--   and corresponding start solutions, in hexa double precision.
  ...
  --   defined in hexa double precision in HexaDobl_Homotopy.
