...
package PentDobl_Rational_Approximations is

-- DESCRIPTION :
--   Given a power series, computes a rational approximation for
--   the function represented by the series, in penta double precision.
  ...
  procedure Denominator_System
              ( numdeg,dendeg : in integer32; 
                ...
                rhs : out PentDobl_Complex_Vectors.Vector );
  ...
  procedure Assign_Numerator_Coefficients
              ( numdeg,dendeg : in integer32;
                ...
                cff : out PentDobl_Complex_Vectors.Vector );
  ...
  function Evaluate
              ( num,den : PentDobl_Complex_Vectors.Vector;
                x : penta_double ) return Complex_Number;
  function Evaluate
              ( num,den : PentDobl_Complex_Vectors.Vector;
                x : Complex_Number ) return Complex_Number;
  ...
  procedure Evaluate
              ( num,den : in PentDobl_Complex_VecVecs.VecVec;
                x : in penta_double;
                eva : out PentDobl_Complex_Vectors.Vector );
  procedure Evaluate
              ( num,den : in PentDobl_Complex_VecVecs.VecVec;
                x : in Complex_Number;
                eva : out PentDobl_Complex_Vectors.Vector );
