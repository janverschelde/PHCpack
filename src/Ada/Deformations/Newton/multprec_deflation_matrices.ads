...
with Multprec_Complex_VecMats;         use Multprec_Complex_VecMats;
with Multprec_Jacobian_Trees;          use Multprec_Jacobian_Trees;

package Multprec_Deflation_Matrices is
...
--   in the Jacobian matrices which arise in the deflation algorithm.
  ...
  -- DESCRIPTION :
  --   Returns a zero matrix with #rows in rows and #columns in cols.
...
-- ASSIGNMENTS :
  ...
  procedure Assign_Scaling_Coefficients
              ( A : in out Link_to_Matrix;
                h : in Multprec_Complex_Vectors.Link_to_Vector );
  ...
  procedure Assign_from_Jacobian_Matrices
              ( A : in out Link_to_Matrix; col : in out integer32;
                jms : in Link_to_VecMat; nbcols : in integer32 );
