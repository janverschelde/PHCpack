...
package QuadDobl_Deflation_Methods is

-- DESCRIPTION :
--   This package offers several implementations of Newton's method
--   with deflation for isolated singularities in quad double arithmetic.
...
-- INTERACTIVE NEWTON with DEFLATION :
  ...
  procedure Add_Multipliers
              ( file : in file_type; output : in boolean;
                ...
                m : in natural32; res : out quad_double );
  ...
  procedure Add_Multipliers_for_Corank_One
              ( file : in file_type; output : in boolean;
                z : in out QuadDobl_Complex_Vectors.Link_to_Vector;
                f : in QuadDobl_Complex_Poly_Systems.Poly_Sys;
                n,m : in natural32; res : out quad_double );
  ...
  procedure Add_Deflation_Data
              ( k : in integer32; m : in natural32;
                ...
                h : in out QuadDobl_Complex_VecVecs.VecVec );
