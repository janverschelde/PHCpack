...
package Multprec_Nullity_Polynomials is

-- DESCRIPTION :
--   This package collects the auxiliary operations necessary to build
--   and evaluate nullity matrices using multiprecision arithmethic.
--   Polynomials subjected to these operations are "nullity polynomials".
