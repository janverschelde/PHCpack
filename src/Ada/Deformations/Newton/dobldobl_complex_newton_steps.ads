...
package DoblDobl_Complex_Newton_Steps is
...
--   Jacobian matrix, all in standard complex floating-point arithmetic.
  ...
  function Inverse_Condition_Number ( s : Vector ) return double_double;
  ...
  procedure Silent_Newton_Step
              ( n : in natural32; z : in out Vector; tol : in double_float;
                err,rco,res : out double_double; rank : out natural32 );
