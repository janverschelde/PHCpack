...
package QuadDobl_Coefficient_Homotopy is
...
-- PART I : for a pair of polynomials
  ...
  function Coefficients ( p : Poly ) return QuadDobl_Complex_Vectors.Vector;
  ...
  function Evaluated_Coefficients
             ( nbcff : integer32;
               ...
               t : quad_double ) return QuadDobl_Complex_Vectors.Vector;
...
-- PART II : for a pair of polynomial systems
  ...
  function Coefficients
             ( p : Poly_Sys ) return QuadDobl_Complex_VecVecs.VecVec;
