...
with DoblDobl_Orthogonal_Correctors;     use DoblDobl_Orthogonal_Correctors;
...
package body DoblDobl_Path_Trackers is
...
-- LINEAR PATH FOLLOWING FOR ONE PATH :
  ...
  procedure Linear_Single_Conditioned_Silent_Continue
    ...
    dt,ds,logs : Double_Double_Vectors.Vector(0..rtoric)
               := (0..rtoric => zero);
    logx : VecVec(0..rtoric);
    wvl0,wvl1,wvl2 : VecVec(1..rtoric);
    errv : Double_Double_Vectors.Vector(0..rtoric) := (0..rtoric => zero);
