...
package body Octo_Double_Theta_Algorithm is
  ...
  begin
    ...
    for i in tab'range loop
       declare
         col : constant Octo_Double_Vectors.Vector(0..dim)
             := (0..dim => zero);
         use Octo_Double_Vectors;
       begin
         if tab(i) = null then
           tab(i) := new Octo_Double_Vectors.Vector'(col);
         else -- the dimension may not match, must clear first
           Octo_Double_Vectors.Clear(tab(i));
           tab(i) := new Octo_Double_Vectors.Vector'(col);
         end if;
       end;
    end loop;
  ...
  procedure Columns 
    ...
    d0,d1,d2,newtheta : octo_double;
    prvcol1,prvcol2 : Octo_Double_Vectors.Link_to_Vector;
  ...
  procedure New_Column
    ...
    two : constant octo_double := Octo_Double_Numbers.create(2.0);
    d0,d1,d2,newtheta : octo_double;
    lastcol1,lastcol2 : Octo_Double_Vectors.Link_to_Vector;
