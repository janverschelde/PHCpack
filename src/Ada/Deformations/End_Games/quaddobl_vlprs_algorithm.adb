...
with QuadDobl_vLpRs_Tables;              use QuadDobl_vLpRs_Tables;

package body QuadDobl_vLpRs_Algorithm is
...
-- OUTPUT ROUTINES OF ERROR :
  ...
  procedure Write ( file : in file_type; k : in integer32; 
                    s : in quad_double; L,v : in Vector ) is
