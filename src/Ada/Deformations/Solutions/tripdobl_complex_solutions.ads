...
package TripDobl_Complex_Solutions is

-- DESCRIPTION :
--   This package provides an abstraction of a list and an array
--   of solutions as vectors of triple double complex numbers.
...
-- DATA STRUCTURES :
  ...
  type Solution ( n : integer32 ) is record
    ...
    err : triple_double;        -- error = |correction| from Newton
    rco : triple_double;        -- inverse of condition number
    res : triple_double;        -- norm of residual vector
  end record;
...
-- CREATORS :
  ...
  --   into a representation that uses triple double numbers.
