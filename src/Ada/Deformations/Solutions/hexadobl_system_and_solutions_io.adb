...
with HexaDobl_Complex_Laur_Systems_io;   use HexaDobl_Complex_Laur_Systems_io;
with HexaDobl_Complex_Solutions_io;      use HexaDobl_Complex_Solutions_io;

package body HexaDobl_System_and_Solutions_io is
...
-- TARGET ROUTINES :
  ...
  procedure put ( file : in file_type;
    ...
    nbvar : constant natural32
          := HexaDobl_Complex_Polynomials.Number_of_Unknowns(p(p'first));
  ...
  procedure put ( file : in file_type;
    ...
    nbvar : constant natural32
          := HexaDobl_Complex_Laurentials.Number_of_Unknowns(p(p'first));
    nbequ : constant natural32 := natural32(p'last);
...
end HexaDobl_System_and_Solutions_io;
