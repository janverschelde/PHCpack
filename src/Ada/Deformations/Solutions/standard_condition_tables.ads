...
package Standard_Condition_Tables is
...
--   for a list of solutions.
  ...
  procedure Update_Corrector ( t : in out Vector; e : in double_float );
  procedure Update_Corrector ( t : in out Vector; s : in Solution );
  procedure Update_Condition ( t : in out Vector; c : in double_float );
  procedure Update_Condition ( t : in out Vector; s : in Solution );
  procedure Update_Distance  ( t : in out Vector; d : in double_float );
  procedure Update_Residuals ( t : in out Vector; r : in double_float );
