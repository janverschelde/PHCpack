...
with DecaDobl_Complex_Laur_Systems_io;   use DecaDobl_Complex_Laur_Systems_io;
with DecaDobl_Complex_Solutions_io;      use DecaDobl_Complex_Solutions_io;

package body DecaDobl_System_and_Solutions_io is
...
-- TARGET ROUTINES :
  ...
  procedure put ( file : in file_type;
    ...
    nbvar : constant natural32
          := DecaDobl_Complex_Polynomials.Number_of_Unknowns(p(p'first));
  ...
  procedure put ( file : in file_type;
    ...
    nbvar : constant natural32
          := DecaDobl_Complex_Laurentials.Number_of_Unknowns(p(p'first));
    nbequ : constant natural32 := natural32(p'last);
...
end DecaDobl_System_and_Solutions_io;
