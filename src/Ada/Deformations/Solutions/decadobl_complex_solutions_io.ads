...
package DecaDobl_Complex_Solutions_io is
...
-- FOR SOLUTION VECTORS ONLY :
  ...
  procedure put_vector ( v : in DecaDobl_Complex_Vectors.Vector );
  procedure put_vector ( file : in file_type; 
                         v : in DecaDobl_Complex_Vectors.Vector );
...
end DecaDobl_Complex_Solutions_io;
