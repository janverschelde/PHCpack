...
with PentDobl_Complex_Laur_Systems_io;   use PentDobl_Complex_Laur_Systems_io;
with PentDobl_Complex_Solutions_io;      use PentDobl_Complex_Solutions_io;

package body PentDobl_System_and_Solutions_io is
...
-- TARGET ROUTINES :
  ...
  procedure put ( file : in file_type;
    ...
    nbvar : constant natural32
          := PentDobl_Complex_Polynomials.Number_of_Unknowns(p(p'first));
  ...
  procedure put ( file : in file_type;
    ...
    nbvar : constant natural32
          := PentDobl_Complex_Laurentials.Number_of_Unknowns(p(p'first));
    nbequ : constant natural32 := natural32(p'last);
...
end PentDobl_System_and_Solutions_io;
