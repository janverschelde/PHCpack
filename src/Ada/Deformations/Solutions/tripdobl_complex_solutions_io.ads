...
package TripDobl_Complex_Solutions_io is
...
-- FOR SOLUTION VECTORS ONLY :
  ...
  procedure put_vector ( v : in TripDobl_Complex_Vectors.Vector );
  procedure put_vector ( file : in file_type; 
                         v : in TripDobl_Complex_Vectors.Vector );
...
end TripDobl_Complex_Solutions_io;
