...
package body TripDobl_Parameter_Systems is
  ...
  begin
    ...
    nb_unk := integer32(TripDobl_Complex_Polynomials.Number_of_Unknowns(p(1)));
  ...
  function Substitute
             ( t : TripDobl_Complex_Polynomials.Term;
               ...
               vals : TripDobl_Complex_Vectors.Vector )
...
end TripDobl_Parameter_Systems; 
