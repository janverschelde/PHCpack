...
package body PentDobl_Parameter_Systems is
  ...
  begin
    ...
    nb_unk := integer32(PentDobl_Complex_Polynomials.Number_of_Unknowns(p(1)));
  ...
  function Substitute
             ( t : PentDobl_Complex_Polynomials.Term;
               ...
               vals : PentDobl_Complex_Vectors.Vector )
...
end PentDobl_Parameter_Systems; 
