...
package body DecaDobl_Parameter_Systems is
  ...
  begin
    ...
    nb_unk := integer32(DecaDobl_Complex_Polynomials.Number_of_Unknowns(p(1)));
  ...
  function Substitute
             ( t : DecaDobl_Complex_Polynomials.Term;
               ...
               vals : DecaDobl_Complex_Vectors.Vector )
...
end DecaDobl_Parameter_Systems; 
