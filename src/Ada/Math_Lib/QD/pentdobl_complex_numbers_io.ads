...
package PentDobl_Complex_Numbers_io is

-- DESCRIPTION :
--   This package provides input and output routines
--   for complex numbers in penta double precision.
  ...
  -- DESCRIPTION :
  --   Reads a penta double complex number from standard input
  --   or from file into c.
  ...
  -- DESCRIPTION :
  --   Writes the penta double complex number c to standard output
  --   or to file, using default precision of 80 decimal places.
...
end PentDobl_Complex_Numbers_io;
