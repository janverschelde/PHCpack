...
with PentDobl_Complex_Numbers_Polar;     use PentDobl_Complex_Numbers_Polar;

package body Test_PentDobl_Complex is
  ...
  procedure Test_Addition_and_Subtraction is
    ...
    x : constant Complex_Number := PentDobl_Random_Numbers.Random;
    y : constant Complex_Number := PentDobl_Random_Numbers.Random;
    s,d : Complex_Number;
  ...
  procedure Test_Random is
    ...
    rnc : constant Complex_Number := PentDobl_Random_Numbers.Random1;
    x : constant penta_double := REAL_PART(rnc);
    y : constant penta_double := IMAG_PART(rnc);
    rad : constant penta_double
        := PentDobl_Mathematical_Functions.Radius(x,y);
  ...
  begin
    new_line;
    put_line("Solving x^d - c = 0, for a penta double complex number c.");
    new_line;
  ...
  begin
    new_line;
    put_line("Testing penta double complex arithmetic ...");
