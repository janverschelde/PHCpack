Quad double arithmetic for PHCv2.4.80
...
ts_tridbl                    : test on triple double arithmetic
...
ts_octdbl                    : test on octo double arithmetic
...
ts_tdcmplx                   : test on triple double complex numbers
...
ts_odcmplx                   : test on octo double complex numbers
...
ts_pentadbl                  : test on penta double arithmetic
ts_decadbl                   : test on deca double arithmetic
------------------------------------------------------------------------------
