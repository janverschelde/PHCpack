...
begin
  ...
  put_line("  8. octo double precision");
  put_line("  A. deca double precision");
  put("Type 2, 3, 4, 5, 8, or A to select a precistion : ");
  ...
  case ans is
    ...
    when '8' => Test_Multprec_OctoDobl_Casts.Main;
    when 'A' => Test_Multprec_DecaDobl_Casts.Main;
    when others => null;
  end case;
end ts_mpcasts;
