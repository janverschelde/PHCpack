package Test_HexaDobl_Complex is

-- DESCRIPTION :
--   Tests the operations on complex numbers in hexa double precision.
  ...
  -- DESCRIPTION :
  --   Tests x + y - x for randomly generated complex hexa doubles.
