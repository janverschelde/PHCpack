...
with DoblDobl_Complex_Series_VecVecs;    use DoblDobl_Complex_Series_VecVecs;
with DoblDobl_Complex_Series_Matrices;
with DoblDobl_Complex_Matrix_Series;

package DoblDobl_Random_Series_Matrices is
...
--   in vectors of vectors and matrices.
  ...
  function Random_Series_Matrix
             ...
             return DoblDobl_Complex_Series_Matrices.Matrix;
  ...
  function Random_Matrix_Series
             ...
             return DoblDobl_Complex_Matrix_Series.Matrix;
