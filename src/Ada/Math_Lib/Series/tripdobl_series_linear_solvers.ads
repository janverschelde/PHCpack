...
--   followed by two backsubstitutions.
  ...
  procedure LUsolve ( A : in TripDobl_Complex_Series_Matrices.Matrix;
                      ...
                      b : in out TripDobl_Complex_Series_Vectors.Vector );
