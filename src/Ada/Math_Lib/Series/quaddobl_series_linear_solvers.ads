...
--   followed by two backsubstitutions.
  ...
  procedure LUsolve ( A : in QuadDobl_Complex_Series_Matrices.Matrix;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out QuadDobl_Complex_Series_Vectors.Vector );
...
end QuadDobl_Series_Linear_Solvers;
