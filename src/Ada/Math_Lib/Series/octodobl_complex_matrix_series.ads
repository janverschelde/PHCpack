...
package OctoDobl_Complex_Matrix_Series is
...
--   All coefficients are in octo double precision.

  type Matrix ( deg : integer32 ) is record
    cff : OctoDobl_Complex_VecMats.VecMat(0..deg);
  end record;

-- CONSTRUCTORS :

  function Create ( A : OctoDobl_Complex_Series_Matrices.Matrix )
                  return OctoDobl_Complex_Matrix_Series.Matrix;
  ...
  function Create ( A : OctoDobl_Complex_Matrix_Series.Matrix )
                  return OctoDobl_Complex_Series_Matrices.Matrix;
