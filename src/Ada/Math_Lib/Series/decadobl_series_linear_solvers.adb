...
package body DecaDobl_Series_Linear_Solvers is
  ...
  function cabs ( s : Series ) return deca_double is
  begin
    return cabs(s.cff(0));
  end cabs;

  procedure LUfac ( A : in out DecaDobl_Complex_Series_Matrices.Matrix;
                    n : in integer32;
  ...
  procedure LUsolve ( A : in DecaDobl_Complex_Series_Matrices.Matrix;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out DecaDobl_Complex_Series_Vectors.Vector ) is
...
end DecaDobl_Series_Linear_Solvers;
