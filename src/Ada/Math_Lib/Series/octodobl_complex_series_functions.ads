...
package OctoDobl_Complex_Series_Functions is

-- DESCRIPTION :
--   Functions are provided to evaluate and shift series 
--   in octo double precision.

  function Eval ( s : Series; t : octo_double ) return Complex_Number;
  ...
  function Eval ( s : Link_to_Series;
                  t : octo_double ) return Complex_Number;
  function Eval ( s : Link_to_Series;
...
-- SHIFT OPERATORS :
  ...
  function Shift ( s : Series; c : octo_double ) return Series;
  ...
  function Shift ( s : Link_to_Series;
                   c : octo_double ) return Link_to_Series;
  function Shift ( s : Link_to_Series;
  ...
  procedure Shift ( s : in out Series; c : in octo_double );
  procedure Shift ( s : in out Series; c : in Complex_Number );

  -- DESCRIPTION :
  --   On return, s = Shift(s,c).

  procedure Shift ( s : in Link_to_Series; c : in octo_double );
