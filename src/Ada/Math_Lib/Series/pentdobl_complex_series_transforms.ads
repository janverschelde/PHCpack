...
package PentDobl_Complex_Series_Transforms is
...
--   The operations, which run in penta double precision, 
...
--   so all coefficients have modulus one or less.
  ...
  procedure Maximum_Coefficient_Modulus
              ( s : in Series;
                idx : out integer32; maxcff : out penta_double );
  ...
  procedure Coefficient_Modulus_Transform
              ( s : in out Series;
                idx : in integer32; maxcff : in penta_double );
