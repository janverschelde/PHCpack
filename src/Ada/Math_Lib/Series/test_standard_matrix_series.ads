...
package Test_Standard_Matrix_Series is

-- DESCRIPTION :
--   Tests matrices of truncated dense power series in double precision.
  ...
  procedure Write ( A : in Standard_Complex_Series_Matrices.Matrix );

  -- DESCRIPTION :
  --   Basic output of a matrix of standard series.

  procedure Write ( A : in Standard_Complex_Matrices.Matrix );

  -- DESCRIPTION :
  --   Basic output of a standard complex matrix.

  procedure Standard_Random_Linear_Solve ( n,degree : in integer32 );
  ...
  procedure Zero_QRD ( A : Standard_Complex_Series_Matrices.Matrix );
  ...
  procedure Solve_Normal_Equations
              ( A : in Standard_Complex_Series_Matrices.Matrix;
                x,b : in Standard_Complex_Series_Vectors.Vector );
  ...
  procedure Test_Normality
              ( qr : in Standard_Complex_Series_Matrices.Matrix );
  ...
  procedure Test_Basis
              ( wrk,A : in Standard_Complex_Series_Matrices.Matrix );
  ...
  procedure Standard_Random_Least_Squares ( n,m,degree : in integer32 );
  ...
  procedure Standard_Test_Conversion ( n,m,d : in integer32 );
