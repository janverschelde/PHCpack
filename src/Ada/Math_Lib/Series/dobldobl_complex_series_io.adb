...
package body DoblDobl_Complex_Series_io is
  ...
  begin
    if s /= null
     then DoblDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg));
    end if;
  end put;
  ...
  begin
    if s /= null
     then DoblDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg),dp);
    end if;
  end put;

end DoblDobl_Complex_Series_io;
