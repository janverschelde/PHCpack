...
--   Test on series with complex coefficients in penta double precision.
  ...
  procedure PentDobl_Random_Test_Poly_Root ( degree : in integer32 );
  ...
  procedure PentDobl_Test_Shift ( degree : in integer32 );

  -- DESCRIPTION :
  --   Does a basic test on shifting the series parameter
  --   on random series of the given degree.

  procedure PentDobl_Test_Transform ( degree : in integer32 );
