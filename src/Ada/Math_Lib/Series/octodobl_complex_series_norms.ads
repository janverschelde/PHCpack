...
--   computed in octo double precision.
  ...
  function Max_Norm ( s : Series ) return octo_double;

  -- DESCRIPTION :
  --   The max norm of a series is the absolute value
  --   of the largest coefficient.

  function Two_Norm ( s : Series ) return octo_double;
