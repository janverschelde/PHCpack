...
package Standard_Linear_Series_Solvers is
...
--   followed by two backsubstitutions.
  ...
  procedure LUfac ( A : in out Standard_Dense_Series_Matrices.Matrix;
                    n : in integer32;
  ...
  procedure LUsolve ( A : in Standard_Dense_Series_Matrices.Matrix;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out Standard_Dense_Series_Vectors.Vector );
...
end Standard_Linear_Series_Solvers;
