...
package Test_PentDobl_CSeries_Polynomials is

-- DESCRIPTION :
--   Tests polynomials in several variables, with as coefficients
--   truncated power series in penta double precision.
 
  procedure Write ( s : in PentDobl_CSeries_Polynomials.Poly );

  -- DESCRIPTION :
  --   Very simple output of a polynomial with series coefficients.
 
  procedure PentDobl_Test_Conversion;
  ...
  --   where s'first = 1, in penta double precision.

  procedure PentDobl_Frequent_Evaluation 
              ( dim,deg : in integer32;
                pol : in PentDobl_CSeries_Polynomials.Poly );
  ...
  procedure PentDobl_Test_Evaluation;
  ...
  procedure PentDobl_Test_Input_Output;

  -- DESCRIPTION :
  --   Reads a series in symbolic format and writes the series back.

  procedure PentDobl_Test_Polynomial_Series;
