...
package body TripDobl_Series_Linear_Solvers is
  ...
  function cabs ( s : Series ) return triple_double is
  begin
    return cabs(s.cff(0));
  end cabs;

  procedure LUfac ( A : in out TripDobl_Complex_Series_Matrices.Matrix;
                    n : in integer32;
  ...
  procedure LUsolve ( A : in TripDobl_Complex_Series_Matrices.Matrix;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out TripDobl_Complex_Series_Vectors.Vector ) is
...
end TripDobl_Series_Linear_Solvers;
