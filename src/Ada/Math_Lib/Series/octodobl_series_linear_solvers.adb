...
package body OctoDobl_Series_Linear_Solvers is
  ...
  function cabs ( s : Series ) return octo_double is
  begin
    return cabs(s.cff(0));
  end cabs;
  ...
  procedure LUsolve ( A : in OctoDobl_Complex_Series_Matrices.Matrix;
                      ...
                      b : in out OctoDobl_Complex_Series_Vectors.Vector ) is
