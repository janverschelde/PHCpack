...
package body OctoDobl_Complex_Series_io is
  ...
  begin
    OctoDobl_Complex_Vectors_io.get(file,s.cff(0..s.deg));
  end get;
  ...
  begin
    OctoDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg));
  end put;
  ...
  begin
    if s /= null
     then OctoDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg));
    end if;
  end put;
  ...
  begin
    OctoDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg),dp);
  end put;
  ...
  begin
    if s /= null
     then OctoDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg),dp);
    end if;
  end put;

end OctoDobl_Complex_Series_io;
