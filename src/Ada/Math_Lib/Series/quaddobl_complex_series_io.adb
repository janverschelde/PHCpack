...
package body QuadDobl_Complex_Series_io is
  ...
  begin
    QuadDobl_Complex_Vectors_io.get(file,s.cff(0..s.deg));
  end get;
  ...
  begin
    QuadDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg));
  end put;
  ...
  begin
    if s /= null
     then QuadDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg));
    end if;
  end put;
  ...
  begin
    QuadDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg),dp);
  end put;
  ...
  begin
    if s /= null
     then QuadDobl_Complex_Vectors_io.put_line(file,s.cff(0..s.deg),dp);
    end if;
  end put;

end QuadDobl_Complex_Series_io;
