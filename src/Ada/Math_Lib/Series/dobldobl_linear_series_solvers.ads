...
package DoblDobl_Linear_Series_Solvers is

-- DESCRIPTION :
--   A square linear system of series is solved by LU factorization,
--   followed by two backsubstitutions, done in double double precision.

  function cabs ( c : Complex_Number ) return double_double;

  -- DESCRIPTION :
  --   Returns the sum of the absolute values of real
  --   and imaginary parts of the complex number c.

  function cabs ( s : Series ) return double_double;

  -- DESCRIPTION :
  --   Returns the cabs of the constant coefficient of the series s.

  procedure LUfac ( A : in out DoblDobl_Dense_Series_Matrices.Matrix;
                    n : in integer32;
  ...
  procedure LUsolve ( A : in DoblDobl_Dense_Series_Matrices.Matrix;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out DoblDobl_Dense_Series_Vectors.Vector );
...
end DoblDobl_Linear_Series_Solvers;
