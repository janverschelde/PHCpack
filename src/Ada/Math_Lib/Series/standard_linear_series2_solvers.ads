...
--   followed by two backsubstitutions.
  ...
  procedure LUsolve ( A : in Standard_Dense_Series2_Matrices.Matrix;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out Standard_Dense_Series2_Vectors.Vector );
...
end Standard_Linear_Series2_Solvers;
