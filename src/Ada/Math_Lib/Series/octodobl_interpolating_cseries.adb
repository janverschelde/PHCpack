...
package body OctoDobl_Interpolating_CSeries is
  ...
  function Eval ( v : OctoDobl_Complex_Vector_Series.Vector;
    ...
    vec : OctoDobl_Complex_Vectors.Link_to_Vector := v.cff(0);
  ...
  function Sample ( v : OctoDobl_Complex_Vector_Series.Vector;
    ...
    lv : OctoDobl_Complex_Vectors.Link_to_Vector := v.cff(0);
  ...
  function Sample ( m : OctoDobl_Complex_Matrix_Series.Matrix;
    ...
    lm : OctoDobl_Complex_Matrices.Link_to_Matrix := m.cff(0);
  ...
  function Interpolate
    ...
    m : OctoDobl_Complex_VecMats.VecMat(t'range) := Sample(mat,t);
    v : OctoDobl_Complex_VecVecs.VecVec(t'range) := Sample(rhs,t);
  ...
  function Diff ( m : OctoDobl_Complex_VecMats.VecMat;
    ...
    one : constant octo_double := create(1.0);
    lm0 : OctoDobl_Complex_Matrices.Link_to_Matrix := m(0);
  ...
  function Hermite_Laurent_Interpolate
    ...
    b : OctoDobl_Complex_Vectors.Vector(1..nrows)
