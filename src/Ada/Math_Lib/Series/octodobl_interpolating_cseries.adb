...
with OctoDobl_Complex_QR_Least_Squares;
with OctoDobl_Complex_Singular_Values;

package body OctoDobl_Interpolating_CSeries is

  function Eval ( v : OctoDobl_Complex_Vector_Series.Vector;
                  t : Complex_Number )
                return OctoDobl_Complex_Vectors.Vector is

    vec : constant OctoDobl_Complex_Vectors.Link_to_Vector := v.cff(0);
    res : OctoDobl_Complex_Vectors.Vector(vec'range) := vec.all;
  ...
  function Eval ( m : OctoDobl_Complex_Matrix_Series.Matrix;
                  t : Complex_Number )
                return OctoDobl_Complex_Matrices.Matrix is

    mat : OctoDobl_Complex_Matrices.Link_to_Matrix := m.cff(0);
    res : OctoDobl_Complex_Matrices.Matrix(mat'range(1),mat'range(2))
        := mat.all;
    one : constant octo_double := create(1.0);
    pwt : Complex_Number := Create(one);
  ...
  function Rank ( A : OctoDobl_Complex_Matrices.Matrix;
    ...
    v : OctoDobl_Complex_Matrices.Matrix(1..p,1..p);
    job : constant integer32 := 11;
    info : integer32;
    x : OctoDobl_Complex_Matrices.Matrix(A'range(1),A'range(2)) := A;

  begin
    OctoDobl_Complex_Singular_Values.SVD(x,n,p,s,e,u,v,job,info);
    return OctoDobl_Complex_Singular_Values.Rank(s,tol);
  end Rank;

  function Full_Rank
             ( m : OctoDobl_Complex_Matrix_Series.Matrix;
               d : integer32; verbose : boolean := true ) return boolean is

    t : constant Complex_Number := OctoDobl_Random_Numbers.Random1;
    mat : OctoDobl_Complex_Matrices.Link_to_Matrix := m.cff(0);
    val : OctoDobl_Complex_Matrices.Matrix(mat'range(1),mat'range(2))
        := mat.all;
    one : constant octo_double := create(1.0);
    pwt : Complex_Number := Create(one);
  ...
  begin
    ...
    OctoDobl_Complex_Singular_Values.SVD(val,n,p,s,e,u,v,job,info);
    rnk := OctoDobl_Complex_Singular_Values.Rank(s,tol);
    if verbose then
  ...
  function Sample ( v : OctoDobl_Complex_Vector_Series.Vector;
                    t : OctoDobl_Complex_Vectors.Vector )
                  return OctoDobl_Complex_VecVecs.VecVec is

    res : OctoDobl_Complex_VecVecs.VecVec(t'range);
    lv : constant OctoDobl_Complex_Vectors.Link_to_Vector := v.cff(0);

  begin
    for i in t'range loop
      declare
        e : constant OctoDobl_Complex_Vectors.Vector(lv'range)
          := Eval(v,t(i));
      begin
        res(i) := new OctoDobl_Complex_Vectors.Vector'(e);
      end;
    end loop;
    return res;
  end Sample;

  function Sample ( m : OctoDobl_Complex_Matrix_Series.Matrix;
                    t : OctoDobl_Complex_Vectors.Vector )
                  return OctoDobl_Complex_VecMats.VecMat is

    res : OctoDobl_Complex_VecMats.VecMat(t'range);
    lm : constant OctoDobl_Complex_Matrices.Link_to_Matrix := m.cff(0);

  begin
    for i in t'range loop
      declare
        e : constant OctoDobl_Complex_Matrices.Matrix(lm'range(1),lm'range(2))
          := Eval(m,t(i));
      begin
        res(i) := new OctoDobl_Complex_Matrices.Matrix'(e);
      end;
    end loop;
    return res;
  end Sample;
  ...
  function Solve_Linear_Systems
             ( m : OctoDobl_Complex_VecMats.VecMat;
               v : OctoDobl_Complex_VecVecs.VecVec )
             return OctoDobl_Complex_VecVecs.VecVec is

    res : OctoDobl_Complex_VecVecs.VecVec(m'range);
    dim : constant integer32 := v(0)'last;
    info : integer32;
    ipvt : Standard_Integer_Vectors.Vector(1..dim);
    sol : OctoDobl_Complex_Vectors.Vector(1..dim);
    wrk : OctoDobl_Complex_Matrices.Matrix(1..dim,1..dim);

  begin
    for i in v'range loop
      sol := v(i).all;
      wrk := m(i).all;
      OctoDobl_Complex_Linear_Solvers.lufac(wrk,dim,ipvt,info);
      OctoDobl_Complex_Linear_Solvers.lusolve(wrk,dim,ipvt,sol);
      res(i) := new OctoDobl_Complex_Vectors.Vector'(sol);
    end loop;
    return res;
  ...
  function Residuals
             ( m : OctoDobl_Complex_VecMats.VecMat;
               v,x : OctoDobl_Complex_VecVecs.VecVec )
             return Octo_Double_Vectors.Vector is

    res : Octo_Double_Vectors.Vector(v'range);
    dim : constant integer32 := v(0)'last;
    lm : OctoDobl_Complex_Matrices.Link_to_Matrix;
    lv,lx : OctoDobl_Complex_Vectors.Link_to_Vector;
    wrk : OctoDobl_Complex_Vectors.Vector(1..dim);
  ...
  begin
    for i in res'range loop
      ...
      res(i) := OctoDobl_Complex_Vector_Norms.Max_Norm(wrk);
    end loop;
    return res;
  end Residuals;

  function Transpose ( x : OctoDobl_Complex_VecVecs.VecVec )
                     return OctoDobl_Complex_VecVecs.VecVec is
  ...
  begin
    for i in res'range loop
      res(i) := new OctoDobl_Complex_Vectors.Vector(1..deg+1);
    end loop;
  ...
  function Vandermonde_Matrix
    ...
    one : constant octo_double := create(1.0);
    res : OctoDobl_Complex_Matrices.Matrix(1..dim,1..dim);
    idx : integer32 := 0;
  ...
  function Solve_Interpolation_Systems
             ( v : OctoDobl_Complex_Matrices.Matrix;
               f : OctoDobl_Complex_VecVecs.VecVec )
             return OctoDobl_Complex_VecVecs.VecVec is

    res : OctoDobl_Complex_VecVecs.VecVec(f'range);
    dim : constant integer32 := v'last(1);
    wrk : OctoDobl_Complex_Matrices.Matrix(v'range(1),v'range(2)) := v;
    sol : OctoDobl_Complex_Vectors.Vector(1..dim);
    ipvt : Standard_Integer_Vectors.Vector(1..dim);
    info : integer32;
  ...
  function Interpolate
             ( mat : OctoDobl_Complex_Matrix_Series.Matrix;
               rhs : OctoDobl_Complex_Vector_Series.Vector;
               verbose : boolean := true )
             return OctoDobl_Complex_Vector_Series.Vector is

    res : OctoDobl_Complex_Vector_Series.Vector(mat.deg);
    dim : constant integer32 := rhs.cff(0)'last;
    t : constant OctoDobl_Complex_Vectors.Vector(0..mat.deg)
      := OctoDobl_Random_Vectors.Random_Vector(0,mat.deg);
    m : constant OctoDobl_Complex_VecMats.VecMat(t'range) := Sample(mat,t);
    v : constant OctoDobl_Complex_VecVecs.VecVec(t'range) := Sample(rhs,t);
    x : OctoDobl_Complex_VecVecs.VecVec(t'range);
    r : Octo_Double_Vectors.Vector(t'range);
    xt : OctoDobl_Complex_VecVecs.VecVec(1..dim);
    vdm : OctoDobl_Complex_Matrices.Matrix(1..mat.deg+1,1..mat.deg+1);
    cff : OctoDobl_Complex_VecVecs.VecVec(1..dim);
  ...
  function Diff ( m : OctoDobl_Complex_VecMats.VecMat;
                  t : Complex_Number; pow,ord : integer32 )
                return OctoDobl_Complex_Matrices.Matrix is

    one : constant octo_double := create(1.0);
    lm0 : constant OctoDobl_Complex_Matrices.Link_to_Matrix := m(0);
  ...
  function Hermite_Matrix
    ...
    lmt : constant OctoDobl_Complex_Matrices.Link_to_Matrix := m(0);
    adim : constant integer32 := lmt'last(1);
    rdim : constant integer32 := adim*(m'last+1);
    res : OctoDobl_Complex_Matrices.Matrix(1..rdim,1..rdim);
    wrk : OctoDobl_Complex_Matrices.Matrix(1..adim,1..adim);
  ...
  function Hermite_Vector
    ...
    lv0 : constant OctoDobl_Complex_Vectors.Link_to_Vector := v(0);
    adim : constant integer32 := lv0'last; 
    rdim : constant integer32 := adim*(v'last+1);
    res : OctoDobl_Complex_Vectors.Vector(1..rdim);
    wrk : OctoDobl_Complex_Vectors.Vector(lv0'range);
    one : constant octo_double := create(1.0);
    pwt : Complex_Number := Create(one);
    fac : Complex_Number;
  ...
  function Hermite_Interpolate
    ...
    A : OctoDobl_Complex_Matrices.Matrix(1..bigdim,1..bigdim)
      := Hermite_Matrix(mat.cff(0..deg),t);
    b : OctoDobl_Complex_Vectors.Vector(1..bigdim)
  ...
  begin
    ...
    OctoDobl_Complex_Linear_Solvers.lufac(A,bigdim,ipvt,info);
    OctoDobl_Complex_Linear_Solvers.lusolve(A,bigdim,ipvt,b);
    if verbose then
    ...
    for k in 0..deg loop
      ...
      res.cff(k) := new OctoDobl_Complex_Vectors.Vector'(wrk);
    end loop;
    return res;
  ...
  function Hermite_Laurent_Matrix
    ...
    lmt : OctoDobl_Complex_Matrices.Link_to_Matrix := m(0);
    ...
    res : OctoDobl_Complex_Matrices.Matrix(1..nrows,1..ncols);
  ...
  function Hermite_Laurent_Vector
    ...
    lv : OctoDobl_Complex_Vectors.Link_to_Vector := v(0);
    nvr : constant integer32 := lv'last;
    dim : constant integer32 := nvr*(2*v'last+1);
    res : OctoDobl_Complex_Vectors.Vector(1..dim);
  ...
  procedure Write_Integer_Matrix
              ( A : in OctoDobl_Complex_Matrices.Matrix ) is
  ...
  begin
    for i in A'range(1) loop
      for j in A'range(2) loop
        put(" "); put(integer32(hihihi_part(REAL_PART(A(i,j)))),1);       
      end loop;
      new_line;
    end loop;
  ...
  function Hermite_Laurent_Interpolate
    ...
    zero : constant octo_double := create(0.0);
    res : OctoDobl_Complex_Vector_Series.Vector(deg);
    A : OctoDobl_Complex_Matrices.Matrix(1..nrows,1..ncols)
      := Hermite_Laurent_Matrix(mat.cff(0..deg));
    b : constant OctoDobl_Complex_Vectors.Vector(1..nrows)
    ...
    sol : OctoDobl_Complex_Vectors.Vector(1..ncols);
    rsd,dum,dum2,dum3 : OctoDobl_Complex_Vectors.Vector(1..nrows);
    info,idx : integer32;
    wrk : OctoDobl_Complex_Vectors.Vector(1..nbc);

    use OctoDobl_Complex_QR_Least_Squares;
...
end OctoDobl_Interpolating_CSeries;
