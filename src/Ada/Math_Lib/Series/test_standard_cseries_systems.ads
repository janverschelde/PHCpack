...
package Test_Standard_CSeries_Systems is

-- DESCRIPTION :
--   Tests systems of series polynomials in double precision.
  ...
  procedure Write ( A : Standard_Complex_Series_Matrices.Matrix );
