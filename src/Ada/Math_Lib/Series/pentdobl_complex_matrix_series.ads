...
package PentDobl_Complex_Matrix_Series is
...
--   All coefficients are in penta double precision.

  type Matrix ( deg : integer32 ) is record
    cff : PentDobl_Complex_VecMats.VecMat(0..deg);
  end record;

-- CONSTRUCTORS :

  function Create ( A : PentDobl_Complex_Series_Matrices.Matrix )
                  return PentDobl_Complex_Matrix_Series.Matrix;
  ...
  function Create ( A : PentDobl_Complex_Matrix_Series.Matrix )
                  return PentDobl_Complex_Series_Matrices.Matrix;
