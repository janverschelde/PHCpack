...
package body DecaDobl_Complex_Poly_Systems_io is
  ...
  begin
    ...
    declare
      dp : constant DecaDobl_Complex_Poly_Systems.Poly_Sys
         := Multprec_Poly_Sys_to_DecaDobl_Complex(lp.all);
    begin
      p := new DecaDobl_Complex_Poly_Systems.Poly_Sys'(dp);
    end;
  ...
  begin
    ...
    p := Multprec_Poly_Sys_to_DecaDobl_Complex(lp);
    Multprec_Complex_Poly_Systems.Clear(lp);
  end get;
...
end DecaDobl_Complex_Poly_Systems_io;
