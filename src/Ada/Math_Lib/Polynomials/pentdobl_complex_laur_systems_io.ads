...
with PentDobl_Complex_Laur_Systems;     use PentDobl_Complex_Laur_Systems;

package PentDobl_Complex_Laur_Systems_io is

-- DESCRIPTION :
--   This package provides basic input/output routines of Laurent polynomial
--   systems with penta double complex coefficients.
  ...
  --   the result to a system with penta double complex coefficients.
...
end PentDobl_Complex_Laur_Systems_io;
