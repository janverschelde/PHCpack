...
with OctoDobl_Complex_Laur_Systems;      use OctoDobl_Complex_Laur_Systems;

package OctoDobl_Complex_Laur_Strings is

-- DESCRIPTION :
--   This package writes Laurent polynomials in several variables and 
--   with octo double complex floating-point coefficients to strings,
...
end OctoDobl_Complex_Laur_Strings;
