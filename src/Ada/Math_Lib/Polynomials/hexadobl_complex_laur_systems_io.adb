...
package body HexaDobl_Complex_Laur_Systems_io is
  ...
  begin
    ...
    declare
      dp : constant HexaDobl_Complex_Laur_Systems.Laur_Sys
         := Multprec_Laur_Sys_to_HexaDobl_Complex(lp.all);
    begin
      p := new HexaDobl_Complex_Laur_Systems.Laur_Sys'(dp);
    end;
