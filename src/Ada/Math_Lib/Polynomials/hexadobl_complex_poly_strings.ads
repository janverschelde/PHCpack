...
with HexaDobl_Complex_Term_Lists;        use HexaDobl_Complex_Term_Lists;
with HexaDobl_Complex_Poly_Systems;      use HexaDobl_Complex_Poly_Systems;

package HexaDobl_Complex_Poly_Strings is

-- DESCRIPTION :
--   This package converts polynomials in several variables and with
--   hexa double complex floating-point coefficients into strings,
