...
with PentDobl_Complex_Term_Lists;        use PentDobl_Complex_Term_Lists;
with PentDobl_Complex_Poly_Systems;      use PentDobl_Complex_Poly_Systems;

package PentDobl_Complex_Poly_Strings is

-- DESCRIPTION :
--   This package converts polynomials in several variables and with
--   penta double complex floating-point coefficients into strings,
