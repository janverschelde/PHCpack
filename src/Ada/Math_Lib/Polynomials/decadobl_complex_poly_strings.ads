...
with DecaDobl_Complex_Term_Lists;        use DecaDobl_Complex_Term_Lists;
with DecaDobl_Complex_Poly_Systems;      use DecaDobl_Complex_Poly_Systems;

package DecaDobl_Complex_Poly_Strings is

-- DESCRIPTION :
--   This package converts polynomials in several variables and with
--   deca double complex floating-point coefficients into strings,
