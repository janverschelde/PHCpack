...
with OctoDobl_Complex_Term_Lists;        use OctoDobl_Complex_Term_Lists;
with OctoDobl_Complex_Poly_Systems;      use OctoDobl_Complex_Poly_Systems;

package OctoDobl_Complex_Poly_Strings is

-- DESCRIPTION :
--   This package converts polynomials in several variables and with
--   octo double complex floating-point coefficients into strings,
