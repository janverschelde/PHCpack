...
package body OctoDobl_Complex_Poly_Systems_io is
  ...
  begin
    Multprec_Complex_Polynomials_io.Set_Working_Precision(20);
    Multprec_Complex_Poly_Systems_io.get(lp);
    declare
      dp : constant OctoDobl_Complex_Poly_Systems.Poly_Sys
         := Multprec_Poly_Sys_to_OctoDobl_Complex(lp.all);
    begin
      p := new OctoDobl_Complex_Poly_Systems.Poly_Sys'(dp);
    end;
  ...
  begin
    ...
    p := Multprec_Poly_Sys_to_OctoDobl_Complex(lp);
    Multprec_Complex_Poly_Systems.Clear(lp);
  end get;
