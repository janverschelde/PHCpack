...
package body DecaDobl_Complex_Laur_Strings is

-- NOTE : The implementation is a wrapper to Multprec_Complex_Laur_Strings.

  size : constant natural32 := 26;
  ...
  begin
    ...
    p := Multprec_Laurential_to_DecaDobl_Complex(q);
  ...
  function Write ( p : Poly ) return string is
    ...
    q : Multprec_Complex_Laurentials.Poly
      := DecaDobl_Complex_to_Multprec_Laurential(p);
