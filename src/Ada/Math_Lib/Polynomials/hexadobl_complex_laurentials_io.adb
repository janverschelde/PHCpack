...
package body HexaDobl_Complex_Laurentials_io is
...
-- THE INPUT OPERATIONS :
  ...
  begin
    Multprec_Complex_Laurentials_io.Set_Working_Precision(25);
    Multprec_Complex_Laurentials_io.get(file,mp);
    p := Multprec_Laurential_to_HexaDobl_Complex(mp);
...
-- AUXILIARIES FOR OUTPUT ROUTINES :
  ...
  -- DESCRIPTION :
  --   Writes the deca double complex number to file
...
end HexaDobl_Complex_Laurentials_io;
