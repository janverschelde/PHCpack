...
package body PentDobl_Complex_Laur_Systems_io is
  ...
  begin
    ...
    declare
      dp : constant PentDobl_Complex_Laur_Systems.Laur_Sys
         := Multprec_Laur_Sys_to_PentDobl_Complex(lp.all);
    begin
      p := new PentDobl_Complex_Laur_Systems.Laur_Sys'(dp);
    end;
