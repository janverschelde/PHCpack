...
package body DoblDobl_Complex_Poly_Systems_io is
  ...
  begin
    ...
    declare
      dp : constant DoblDobl_Complex_Poly_Systems.Poly_Sys
         := Multprec_Poly_Sys_to_DoblDobl_Complex(lp.all);
    begin
      p := new DoblDobl_Complex_Poly_Systems.Poly_Sys'(dp);
    end;
  ...
  begin
    ...
    p := Multprec_Poly_Sys_to_DoblDobl_Complex(lp);
    Multprec_Complex_Poly_Systems.Clear(lp);
  end get;
...
end DoblDobl_Complex_Poly_Systems_io;
