...
package body PentDobl_Complex_Poly_Systems_io is
  ...
  begin
    Multprec_Complex_Polynomials_io.Set_Working_Precision(12);
    Multprec_Complex_Poly_Systems_io.get(lp);
    declare
      dp : constant PentDobl_Complex_Poly_Systems.Poly_Sys
         := Multprec_Poly_Sys_to_PentDobl_Complex(lp.all);
    begin
      p := new PentDobl_Complex_Poly_Systems.Poly_Sys'(dp);
    end;
  ...
  begin
    ...
    p := Multprec_Poly_Sys_to_PentDobl_Complex(lp);
    Multprec_Complex_Poly_Systems.Clear(lp);
  end get;
...
end PentDobl_Complex_Poly_Systems_io;
