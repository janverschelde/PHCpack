...
package body DecaDobl_Complex_Polynomials_io is
  ...
  begin
    ...
    p := Multprec_Polynomial_to_DecaDobl_Complex(mp);
...
-- THE OUTPUT OPERATIONS :
  ...
  procedure Write_Number ( file : in file_type; c : in Complex_Number ) is
    ...
    re : constant deca_double := REAL_PART(c);
    im : constant deca_double := IMAG_PART(c);
...
end DecaDobl_Complex_Polynomials_io;
