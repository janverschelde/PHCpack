...
package body Test_TripDobl_Vector_Norms is
  ...
  begin
    ...
    declare   
      v : constant Triple_Double_Vectors.Vector(1..dim)
        := TripDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant triple_double := Norm2(v);
      w : Triple_Double_Vectors.Vector(1..dim);
      wnrm : triple_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant Triple_Double_Vectors.Vector(1..dim)
        := TripDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant triple_double := Sum_Norm(v);
      w : Triple_Double_Vectors.Vector(1..dim);
      wnrm : triple_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant Triple_Double_Vectors.Vector(1..dim)
        := TripDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant triple_double := Max_Norm(v);
      w : Triple_Double_Vectors.Vector(1..dim);
      wnrm : triple_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant TripDobl_Complex_Vectors.Vector(1..dim)
        := TripDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant triple_double := Norm2(v);
      w : TripDobl_Complex_Vectors.Vector(1..dim);
      wnrm : triple_double;
    begin
      put("2-norm of a random vector : "); put(vnrm,3); new_line;
      for k in 1..dim loop
  ...
  begin
    new_line;
    put_line("MENU to test norms of triple double vectors :");
...
end Test_TripDobl_Vector_Norms;
