...
package body DoblDobl_Numerical_Rank is
  ...
  begin
    if vrblvl > 0 then
      put_line("-> in DoblDobl_Numerical_Rank.numerical_rank 0 ...");   
  ...
  procedure Numerical_Rank 
              ( A : in out Matrix; tol : in double_float;
                ...
                rco : out double_double; rank : out natural32;
                vrblvl : integer32 := 0 ) is
  ...
  begin
    if vrblvl > 0 then
      put_line("-> in DoblDobl_Numerical_Rank.numerical_rank 1 ...");   
    end if;
  ...
  begin
    if vrblvl > 0 then
      put_line("-> in DoblDobl_Numerical_Rank.numerical_rank 2 ...");   
    end if;
