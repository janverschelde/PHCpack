...
package body Test_PentDobl_Vector_Norms is
  ...
  begin
    ...
    declare   
      v : constant Penta_Double_Vectors.Vector(1..dim)
        := PentDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant penta_double := Norm2(v);
      w : Penta_Double_Vectors.Vector(1..dim);
      wnrm : penta_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant Penta_Double_Vectors.Vector(1..dim)
        := PentDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant penta_double := Sum_Norm(v);
      w : Penta_Double_Vectors.Vector(1..dim);
      wnrm : penta_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant Penta_Double_Vectors.Vector(1..dim)
        := PentDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant penta_double := Max_Norm(v);
      w : Penta_Double_Vectors.Vector(1..dim);
      wnrm : penta_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant PentDobl_Complex_Vectors.Vector(1..dim)
        := PentDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant penta_double := Norm2(v);
      w : PentDobl_Complex_Vectors.Vector(1..dim);
      wnrm : penta_double;
    begin
      put("2-norm of a random vector : "); put(vnrm,3); new_line;
      for k in 1..dim loop
  ...
  begin
    new_line;
    put_line("MENU to test norms of penta double vectors :");
...
end Test_PentDobl_Vector_Norms;
