...
--   with complex arithmetic in double double precision.
...
--   f77-linpack code.
  ...
  function Norm1 ( a : DoblDobl_Complex_Matrices.Matrix ) return double_double;
  function Norm1 ( a : DoblDobl_Complex_VecVecs.VecVec ) return double_double;
