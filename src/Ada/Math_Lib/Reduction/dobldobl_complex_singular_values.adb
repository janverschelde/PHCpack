...
package body DoblDobl_Complex_Singular_Values is
...
-- AUXILIARY BLAS ROUTINES :
  ...
  function dmax1 ( x1,x2 : double_double ) return double_double is
  ...
  function dmax1 ( x1,x2,x3 : double_double ) return double_double is
  ...
  function dmax1 ( x1,x2,x3,x4 : double_double ) return double_double is
  ...
  function dmax1 ( x1,x2,x3,x4,x5 : double_double ) return double_double is
  ...
  function cabs1 ( z : Complex_Number ) return double_double is
  ...
  function cdabs ( z : Complex_Number ) return double_double is
...
--                   raise;
  ...
  --   and continueing n steps with increment incx.
    ...
    norm,scale,ssq,temp : double_double;
...
--    when others => put_line("exception caught by zdotc"); raise;
  ...
  procedure drotg ( da,db,c,s : in out double_double ) is
...
-- TARGET PROCEDURE :
  ...
  procedure SVD ( x : in out Matrix; n,p : in integer32;
    ...
    t,r : Complex_Number;
    b,c,cs,el,emm1,f,g,scale,shift,sl,sm,sn : double_double;
    smm1,t1,test,ztest : double_double;
    wantu,wantv : boolean;
    zero : constant double_double := create(0.0);
    one : constant double_double := create(1.0);
    minusone : constant double_double := create(-1.0);
...
--         raise;
  ...
  function Inverse_Condition_Number
             ( s : Vector ) return double_double is

    smax : constant double_double := AbsVal(s(s'first));
    one : constant double_double := create(1.0);
    smin,val : double_double;
  ...
  function Inverse_Condition_Number
             ( s : Vector; tol : double_float ) return double_double is
...
end DoblDobl_Complex_Singular_Values;
