...
package body HexaDobl_Complex_Linear_Solvers is
...
-- TARGET ROUTINES :
  ...
  procedure Scale ( a : in out HexaDobl_Complex_Matrices.Matrix;
                    b : in out HexaDobl_Complex_Vectors.Vector ) is

    fac : Complex_Number;

    function Maximum ( a : in HexaDobl_Complex_Matrices.Matrix;
                       i : in integer32 ) return Complex_Number is

      res : integer32 := a'first(2);
      max : hexa_double := cabs(a(i,res));
      tmp : hexa_double;
    ...
    procedure Divide ( a : in out HexaDobl_Complex_Matrices.Matrix;
                       b : in out HexaDobl_Complex_Vectors.Vector;
  ...
  function Norm1 ( a : HexaDobl_Complex_Matrices.Matrix )
  ...
  function Norm1 ( a : HexaDobl_Complex_VecVecs.VecVec )
                 return hexa_double is

    res : hexa_double := Create(0.0);
    sum : hexa_double;
    aj : HexaDobl_Complex_Vectors.Link_to_Vector;
...
-- TARGET ROUTINES :
  ...
  procedure lufac ( a : in out HexaDobl_Complex_Matrices.Matrix;
                    n : in integer32;
    ...
    smax : hexa_double;
    temp : Complex_Number;
    dd_min_one : constant hexa_double := create(-1.0);
  ...
  procedure lufac ( a : in out HexaDobl_Complex_VecVecs.VecVec;
                    n : in integer32;
                    ipvt : out Standard_Integer_Vectors.Vector;
                    info : out integer32 ) is
    ...
    smax : hexa_double;
    temp : Complex_Number;
    ak,aj : HexaDobl_Complex_Vectors.Link_to_Vector;
    dd_min_one : constant hexa_double := create(-1.0);
    cp_min_one : constant Complex_Number := create(dd_min_one);
  ...
  procedure estco ( a : in HexaDobl_Complex_Matrices.Matrix;
                    n : in integer32;
                    ipvt : in Standard_Integer_Vectors.Vector;
                    anorm : in hexa_double; rcond : out hexa_double ) is

    z : HexaDobl_Complex_Vectors.Vector(1..n);
    kb,kp1,l : integer32;
    s,sm,sum,ynorm : hexa_double;
  ...
  procedure estco ( a : in HexaDobl_Complex_VecVecs.VecVec;
                    n : in integer32;
                    ipvt : in Standard_Integer_Vectors.Vector;
                    anorm : in hexa_double; rcond : out hexa_double ) is
  ...
  procedure lufco ( a : in out HexaDobl_Complex_Matrices.Matrix;
                    n : in integer32;
                    ipvt : out Standard_Integer_Vectors.Vector;
                    rcond : out hexa_double ) is

    anorm : constant hexa_double := Norm1(a);
    info : integer32;
  ...
  procedure lufco ( a : in out HexaDobl_Complex_VecVecs.VecVec;
                    n : in integer32;
                    ipvt : out Standard_Integer_Vectors.Vector;
                    rcond : out hexa_double ) is
  ...
  procedure lusolve ( a : in HexaDobl_Complex_Matrices.Matrix;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out HexaDobl_Complex_Vectors.Vector ) is
  ...
  procedure lusolve ( a : in HexaDobl_Complex_VecVecs.VecVec;
                      n : in integer32;
                      ipvt : in Standard_Integer_Vectors.Vector;
                      b : in out HexaDobl_Complex_Vectors.Vector ) is

    ell,nm1,kb : integer32;
    ak : HexaDobl_Complex_Vectors.Link_to_Vector;
    temp : Complex_Number;
  ...
  procedure Triangulate ( a : in out HexaDobl_Complex_Matrices.Matrix;
                          tol : in double_float;
                          n,m : in integer32 ) is
  ...
  procedure Diagonalize ( a : in out HexaDobl_Complex_Matrices.Matrix;
                          n,m : in integer32 ) is
  ...
  begin
    ...
    while (k <= n) and (kcolumn <= m) loop
      ...
      if is_zero(max) then
        ...
        a(k,kcolumn) := HexaDobl_Complex_Numbers.Create(integer(1));
        for i in 1..(k-1) loop
          for j in (kcolumn+1)..m loop
            a(i,j) := a(i,j) - a(i,kcolumn) * a(k,j);
          end loop;
...
-- TO TEST THE LU FACTORIZATION :
  ...
  function Permute ( P : Standard_Natural_Matrices.Matrix;
    ...
    fP : HexaDobl_Complex_Matrices.Matrix(P'range(1),P'range(2));
  ...
  function Lower_Diagonal ( A : HexaDobl_Complex_Matrices.Matrix )
                          return HexaDobl_Complex_Matrices.Matrix is
  ...
  function Upper_Diagonal ( A : HexaDobl_Complex_Matrices.Matrix )
                          return HexaDobl_Complex_Matrices.Matrix is
  ...
  procedure Permute_Lower
              ( L : in out HexaDobl_Complex_Matrices.Matrix;
...
end HexaDobl_Complex_Linear_Solvers;
