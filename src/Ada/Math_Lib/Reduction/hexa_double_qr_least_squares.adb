...
package body Hexa_Double_QR_Least_Squares is
  ...
  function dsign ( a,b : hexa_double ) return hexa_double is
  ...
  procedure dswap ( a : in out Hexa_Double_Matrices.Matrix;
  ...
  procedure dcopy ( n,start : in integer32;
                    x : in Hexa_Double_Vectors.Vector;
                    y : out Hexa_Double_Vectors.Vector ) is
  ...
  function dnrm2 ( a : Hexa_Double_Matrices.Matrix;
                   row,col : integer32 ) return hexa_double is
  ...
  function ddot ( a : Hexa_Double_Matrices.Matrix;
                  row,k1,k2 : integer32 ) return hexa_double is
  ...
  function ddot ( row : integer32;
                  x : Hexa_Double_Matrices.Matrix;
                  y : Hexa_Double_Vectors.Vector )
  ...
  procedure daxpy ( a : in out Hexa_Double_Matrices.Matrix; 
                    f : in hexa_double; row,k1,k2 : in integer32 ) is
  ...
  procedure daxpy ( n,row,col : in integer32; f : in hexa_double;
                    x : in Hexa_Double_Matrices.Matrix;
                    y : in out Hexa_Double_Vectors.Vector ) is
  ...
  procedure dscal ( a : in out Hexa_Double_Matrices.Matrix;
                    f : in hexa_double; row,col : in integer32 ) is
  ...
  procedure QRD ( x : in out Hexa_Double_Matrices.Matrix;
                  qraux : in out Hexa_Double_Vectors.Vector;
    ...
    work : Hexa_Double_Vectors.Vector(x'range(2));
    jj,jp,lp1,lup,maxj,pl,pu : integer32;
    maxnrm,tt,nrmxl,t : hexa_double;
    negj,swapj : boolean;
  ...
  procedure Permute_Columns ( x : in out Hexa_Double_Matrices.Matrix;
                              jpvt : in Standard_Integer_Vectors.Vector ) is

    res : Hexa_Double_Matrices.Matrix(x'range(1),x'range(2));
  ...
  procedure Permute ( x : in out Hexa_Double_Vectors.Vector;
                      jpvt : in Standard_Integer_Vectors.Vector ) is

    res : Hexa_Double_Vectors.Vector(x'range);
  ...
  procedure Basis ( qr : in out Hexa_Double_Matrices.Matrix;
                    x : in Hexa_Double_Matrices.Matrix ) is

    sum : hexa_double;
    wrk : Hexa_Double_Vectors.Vector(qr'range(1));
  ...
  procedure QRLS ( x : in out Hexa_Double_Matrices.Matrix;
                   ldx,n,k : in integer32;
                   qraux,y : in Hexa_Double_Vectors.Vector;
                   qy,qty,b,rsd,xb : out Hexa_Double_Vectors.Vector;
...
end Hexa_Double_QR_Least_Squares;
