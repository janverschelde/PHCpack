...
package body Test_QuadDobl_QRLS_Solvers is
  ...
  begin
    loop
      ...
      put_line("  1. QR-decomposition on given quaddobl real matrix.");
      put_line("  2.                                    complex matrix.");
      put_line("  3.                  on random quaddobl real matrix.");
      put_line("  4.                                     complex matrix.");
      put_line("  5. Least Squares on given quaddobl real matrix.");
      put_line("  6.                                 complex matrix.");
      put_line("  7.               on random quaddobl real matrix.");
