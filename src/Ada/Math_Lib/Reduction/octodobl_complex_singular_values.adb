...
package body OctoDobl_Complex_Singular_Values is
...
-- AUXILIARY BLAS ROUTINES :
  ...
  function dmax1 ( x1,x2 : octo_double ) return octo_double is
  ...
  function dmax1 ( x1,x2,x3 : octo_double ) return octo_double is
  ...
  function dmax1 ( x1,x2,x3,x4 : octo_double ) return octo_double is
  ...
  function dmax1 ( x1,x2,x3,x4,x5 : octo_double ) return octo_double is
  ...
  function cabs1 ( z : Complex_Number ) return octo_double is
  ...
  function cdabs ( z : Complex_Number ) return octo_double is
  ...
  --   For efficiency, this should have been done anyway ...
    ...
    rpz : constant octo_double := REAL_PART(z);
    ipz : constant octo_double := IMAG_PART(z);
...
--                   raise;
  ...
  --   and continueing n steps with increment incx.
    ...
    norm,scale,ssq,temp : octo_double;
...
--    when others => put_line("exception caught by zdotc"); raise;
  ...
  procedure drotg ( da,db,c,s : in out octo_double ) is
...
-- TARGET PROCEDURE :
  ...
  procedure SVD ( x : in out Matrix; n,p : in integer32;
    ...
    t,r : Complex_Number;
    b,c,cs,el,emm1,f,g,scale,shift,sl,sm,sn : octo_double;
    smm1,t1,test,ztest : octo_double;
    wantu,wantv : boolean;
    zero : constant octo_double := create(0.0);
    one : constant octo_double := create(1.0);
    minusone : constant octo_double := create(-1.0);
...
--         raise;
  ...
  function Inverse_Condition_Number
             ( s : Vector ) return octo_double is

    smax : constant octo_double := AbsVal(s(s'first));
    one : constant octo_double := create(1.0);
    smin,val : octo_double;
  ...
  function Inverse_Condition_Number
             ( s : Vector; tol : double_float ) return octo_double is
