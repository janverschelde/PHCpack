...
package body DoblDobl_Complex_QR_Least_Squares is
...
-- AUXILIARIES :
  ...
  function cdabs ( a : Complex_Number ) return double_double is
  ...
  procedure zswap ( a : in out DoblDobl_Complex_Matrices.Matrix;
  ...
  function znrm2 ( a : DoblDobl_Complex_Matrices.Matrix;
  ...
  function zdot ( a : DoblDobl_Complex_Matrices.Matrix;
                  row,k1,k2 : integer32 ) 
  ...
  procedure zaxpy ( a : in out DoblDobl_Complex_Matrices.Matrix; 
  ...
  procedure zscal ( a : in out DoblDobl_Complex_Matrices.Matrix;
  ...
  procedure zaxpy ( n,row,col : in integer32; f : in Complex_Number;
                    x : in DoblDobl_Complex_Matrices.Matrix;
                    y : in out DoblDobl_Complex_Vectors.Vector ) is
  ...
  procedure QRD ( x : in out DoblDobl_Complex_Matrices.Matrix;
                  qraux : in out DoblDobl_Complex_Vectors.Vector;
    ...
    work : DoblDobl_Complex_Vectors.Vector(x'range(2));
    jj,jp,lp1,lup,maxj,pl,pu : integer32;
    zero : constant double_double := create(0.0);
    one : constant double_double := create(1.0);
    maxnrm,tt : double_double;
  ...
  procedure Basis ( qr : in out DoblDobl_Complex_Matrices.Matrix;
  ...
  procedure QRLS ( x : in out DoblDobl_Complex_Matrices.Matrix;
                   n,k : in integer32;
                   qraux,y : in DoblDobl_Complex_Vectors.Vector;
                   qy,qty,b,rsd,xb : out DoblDobl_Complex_Vectors.Vector;
...
end DoblDobl_Complex_QR_Least_Squares;
