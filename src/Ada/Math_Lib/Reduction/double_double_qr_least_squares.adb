...
package body Double_Double_QR_Least_Squares is
...
-- AUXILIARIES :
  ...
  function dsign ( a,b : double_double ) return double_double is
  ...
  procedure dswap ( a : in out Double_Double_Matrices.Matrix;
  ...
  procedure dcopy ( n,start : in integer32;
                    ...
                    y : out Double_Double_Vectors.Vector ) is
  ...
  function dnrm2 ( a : Double_Double_Matrices.Matrix;
                   row,col : integer32 ) return double_double is
  ...
  function ddot ( a : Double_Double_Matrices.Matrix;
                  row,k1,k2 : integer32 ) return double_double is
  ...
  function ddot ( row : integer32;
                  x : Double_Double_Matrices.Matrix;
                  y : Double_Double_Vectors.Vector )
  ...
  procedure daxpy ( a : in out Double_Double_Matrices.Matrix; 
                    f : in double_double; row,k1,k2 : in integer32 ) is
  ...
  procedure daxpy ( n,row,col : in integer32; f : in double_double;
                    x : in Double_Double_Matrices.Matrix;
                    y : in out Double_Double_Vectors.Vector ) is
  ...
  procedure dscal ( a : in out Double_Double_Matrices.Matrix;
                    f : in double_double; row,col : in integer32 ) is
  ...
  procedure QRD ( x : in out Double_Double_Matrices.Matrix;
                  qraux : in out Double_Double_Vectors.Vector;
    ...
    work : Double_Double_Vectors.Vector(x'range(2));
    jj,jp,lp1,lup,maxj,pl,pu : integer32;
    maxnrm,tt,nrmxl,t : double_double;
    negj,swapj : boolean;
  ...
  procedure Permute_Columns ( x : in out Double_Double_Matrices.Matrix;
                              jpvt : in Standard_Integer_Vectors.Vector ) is

    res : Double_Double_Matrices.Matrix(x'range(1),x'range(2));
  ...
  procedure Permute ( x : in out Double_Double_Vectors.Vector;
                      jpvt : in Standard_Integer_Vectors.Vector ) is
  ...
  procedure Basis ( qr : in out Double_Double_Matrices.Matrix;
  ...
  procedure QRLS ( x : in out Double_Double_Matrices.Matrix;
                   ldx,n,k : in integer32;
                   qraux,y : in Double_Double_Vectors.Vector;
                   qy,qty,b,rsd,xb : out Double_Double_Vectors.Vector;
                   job : in integer32; info : out integer32 ) is

    zero : constant double_double := create(0.0);
    cb,cqy,cqty,cr,cxb : boolean;
    jj,ju,kp1 : integer32;
    t,temp : double_double;
...
end Double_Double_QR_Least_Squares;
