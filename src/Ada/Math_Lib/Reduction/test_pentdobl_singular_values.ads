...
package Test_PentDobl_Singular_Values is

-- DESCRIPTION :
--   Tests the Singular Value Decomposition in penta double precision.

  function Read_Vector
             ( n : in integer32 ) return PentDobl_Complex_Vectors.Vector;
  ...
  function Read_Matrix
             ( n,m : in integer32 ) return PentDobl_Complex_Matrices.Matrix;
  ...
  procedure Test_SVD_Solver
               ( a,u,v : in PentDobl_Complex_Matrices.Matrix;
                 s,b : in PentDobl_Complex_Vectors.Vector );
