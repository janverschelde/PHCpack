...
package PentDobl_Complex_Linear_Solvers is

-- DESCRIPTION :
--   This package offers a few routines to solve linear systems of equations,
--   with complex arithmetic in penta double precision.
...
--   f77-linpack code.
  ...
  function Norm1 ( a : PentDobl_Complex_Matrices.Matrix ) return penta_double;
  function Norm1 ( a : PentDobl_Complex_VecVecs.VecVec ) return penta_double;
  ...
  procedure estco ( a : in PentDobl_Complex_Matrices.Matrix;
                    ...
                    anorm : in penta_double; rcond : out penta_double );
