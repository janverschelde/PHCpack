...
package QuadDobl_Complex_QR_Least_Squares is

-- DESCRIPTION :
--   This package provides an implementation of QR-decomposition for
--   matrices of quad double complex numbers.  With this decomposition,
...
--   least squares sense.
  ...
  -- DESCRIPTION :
  --   Applies the output of QuadDobl_Complex_QR_Decomposition.QRD to
