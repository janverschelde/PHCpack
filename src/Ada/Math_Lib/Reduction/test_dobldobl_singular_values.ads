...
package Test_DoblDobl_Singular_Values is

-- DESCRIPTION :
--   Tests the Singular Value Decomposition in double double precision.

  function Read_Vector
             ( n : in integer32 ) return DoblDobl_Complex_Vectors.Vector;
  ...
  function Read_Matrix
             ( n,m : in integer32 ) return DoblDobl_Complex_Matrices.Matrix;
  ...
  procedure Test_SVD_Solver
               ( a,u,v : in DoblDobl_Complex_Matrices.Matrix;
                 s,b : in DoblDobl_Complex_Vectors.Vector );
...
end Test_DoblDobl_Singular_Values;
