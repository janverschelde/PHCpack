...
package Test_DecaDobl_Singular_Values is

-- DESCRIPTION :
--   Tests the Singular Value Decomposition in deca double precision.

  function Read_Vector
             ( n : in integer32 ) return DecaDobl_Complex_Vectors.Vector;
  ...
  function Read_Matrix
             ( n,m : in integer32 ) return DecaDobl_Complex_Matrices.Matrix;
  ...
  procedure Test_SVD_Solver
               ( a,u,v : in DecaDobl_Complex_Matrices.Matrix;
                 s,b : in DecaDobl_Complex_Vectors.Vector );
