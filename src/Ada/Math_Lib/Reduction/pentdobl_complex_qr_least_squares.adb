...
package body PentDobl_Complex_QR_Least_Squares is
  ...
  function cdabs ( a : Complex_Number ) return penta_double is
  ...
  procedure zswap ( a : in out PentDobl_Complex_Matrices.Matrix;
  ...
  procedure zcopy ( n,start : in integer32;
                    ...
                    y : out PentDobl_Complex_Vectors.Vector ) is
  ...
  function znrm2 ( a : PentDobl_Complex_Matrices.Matrix;
  ...
  function zdot ( a : PentDobl_Complex_Matrices.Matrix;
                  row,k1,k2 : integer32 ) 
  ...
  function zdotc ( row : integer32;
                   x : PentDobl_Complex_Matrices.Matrix;
                   y : PentDobl_Complex_Vectors.Vector )
                 return Complex_Number is
  ...
  procedure zaxpy ( a : in out PentDobl_Complex_Matrices.Matrix; 
  ...
  procedure zscal ( a : in out PentDobl_Complex_Matrices.Matrix;
  ...
  procedure zaxpy ( n,row,col : in integer32; f : in Complex_Number;
                    x : in PentDobl_Complex_Matrices.Matrix;
                    y : in out PentDobl_Complex_Vectors.Vector ) is
  ...
  procedure QRD ( x : in out PentDobl_Complex_Matrices.Matrix;
                  qraux : in out PentDobl_Complex_Vectors.Vector;
  ...
  procedure Basis ( qr : in out PentDobl_Complex_Matrices.Matrix;
                    x : in PentDobl_Complex_Matrices.Matrix ) is

    sum : Complex_Number;
    wrk : PentDobl_Complex_Vectors.Vector(qr'range(1));
  ...
  procedure QRLS ( x : in out PentDobl_Complex_Matrices.Matrix;
                   n,k : in integer32;
                   qraux,y : in PentDobl_Complex_Vectors.Vector;
                   qy,qty,b,rsd,xb : out PentDobl_Complex_Vectors.Vector;
...
end PentDobl_Complex_QR_Least_Squares;
