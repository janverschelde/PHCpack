...
package body Test_QuadDobl_Vector_Norms is
  ...
  begin
    ...
    declare   
      v : constant Quad_Double_Vectors.Vector(1..dim)
        := QuadDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant quad_double := Norm2(v);
      w : Quad_Double_Vectors.Vector(1..dim);
      wnrm : quad_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant Quad_Double_Vectors.Vector(1..dim)
        := QuadDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant quad_double := Sum_Norm(v);
      w : Quad_Double_Vectors.Vector(1..dim);
      wnrm : quad_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant Quad_Double_Vectors.Vector(1..dim)
        := QuadDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant quad_double := Max_Norm(v);
      w : Quad_Double_Vectors.Vector(1..dim);
      wnrm : quad_double;
    begin
  ...
  begin
    ...
    declare   
      v : constant QuadDobl_Complex_Vectors.Vector(1..dim)
        := QuadDobl_Random_Vectors.Random_Vector(1,dim);
      vnrm : constant quad_double := Norm2(v);
      w : QuadDobl_Complex_Vectors.Vector(1..dim);
      wnrm : quad_double;
    begin
      put("2-norm of a random vector : "); put(vnrm,3); new_line;
      for k in 1..dim loop
  ...
  begin
    new_line;
    put_line("MENU to test norms of quad double vectors :");
...
end Test_QuadDobl_Vector_Norms;
