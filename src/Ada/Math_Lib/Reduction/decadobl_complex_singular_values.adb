...
package body DecaDobl_Complex_Singular_Values is
...
-- AUXILIARY BLAS ROUTINES :
  ...
  function dmax1 ( x1,x2 : deca_double ) return deca_double is
  ...
  function dmax1 ( x1,x2,x3 : deca_double ) return deca_double is
  ...
  function dmax1 ( x1,x2,x3,x4 : deca_double ) return deca_double is
  ...
  function dmax1 ( x1,x2,x3,x4,x5 : deca_double ) return deca_double is
  ...
  function cabs1 ( z : Complex_Number ) return deca_double is
  ...
  function cdabs ( z : Complex_Number ) return deca_double is
  ...
  --   For efficiency, this should have been done anyway ...
    ...
    rpz : constant deca_double := REAL_PART(z);
    ipz : constant deca_double := IMAG_PART(z);
...
--                   raise;
  ...
  --   and continueing n steps with increment incx.
    ...
    norm,scale,ssq,temp : deca_double;
...
--    when others => put_line("exception caught by zdotc"); raise;
  ...
  procedure drotg ( da,db,c,s : in out deca_double ) is
...
-- TARGET PROCEDURE :
  ...
  procedure SVD ( x : in out Matrix; n,p : in integer32;
    ...
    t,r : Complex_Number;
    b,c,cs,el,emm1,f,g,scale,shift,sl,sm,sn : deca_double;
    smm1,t1,test,ztest : deca_double;
    wantu,wantv : boolean;
    zero : constant deca_double := create(0.0);
    one : constant deca_double := create(1.0);
    minusone : constant deca_double := create(-1.0);
...
--         raise;
  ...
  function Inverse_Condition_Number
             ( s : Vector ) return deca_double is

    smax : constant deca_double := AbsVal(s(s'first));
    one : constant deca_double := create(1.0);
    smin,val : deca_double;
  ...
  function Inverse_Condition_Number
             ( s : Vector; tol : double_float ) return deca_double is
...
end DecaDobl_Complex_Singular_Values;
