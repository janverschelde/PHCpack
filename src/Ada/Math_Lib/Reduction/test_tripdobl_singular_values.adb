...
package body Test_TripDobl_Singular_Values is

  function Read_Vector
             ( n : in integer32 ) return TripDobl_Complex_Vectors.Vector is

    res : TripDobl_Complex_Vectors.Vector(1..n);
  ...
  function Read_Matrix
             ( n,m : in integer32 ) return TripDobl_Complex_Matrices.Matrix is

    res : TripDobl_Complex_Matrices.Matrix(1..n,1..m);
  ...
  procedure Test_SVD_Solver
               ( a,u,v : in TripDobl_Complex_Matrices.Matrix;
                 s,b : in TripDobl_Complex_Vectors.Vector ) is
  ...
  begin
    new_line;
    put_line("Testing the SVD in triple double precision ...");
    new_line;
