...
package TripDobl_Complex_QR_Least_Squares is

-- DESCRIPTION :
--   This package provides an implementation of QR-decomposition for
--   matrices of triple double complex numbers.  With this decomposition,
...
--   least squares sense.
  ...
  -- DESCRIPTION :
  --   Applies the output of TripDobl_Complex_QR_Decomposition.QRD to
