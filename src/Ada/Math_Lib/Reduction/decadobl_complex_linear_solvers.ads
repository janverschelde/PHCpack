...
package DecaDobl_Complex_Linear_Solvers is

-- DESCRIPTION :
--   This package offers a few routines to solve linear systems of equations,
--   with complex arithmetic in deca double precision.
...
--   f77-linpack code.
  ...
  function Norm1 ( a : DecaDobl_Complex_Matrices.Matrix ) return deca_double;
  function Norm1 ( a : DecaDobl_Complex_VecVecs.VecVec ) return deca_double;
  ...
  procedure estco ( a : in DecaDobl_Complex_Matrices.Matrix;
                    ...
                    anorm : in deca_double; rcond : out deca_double );
