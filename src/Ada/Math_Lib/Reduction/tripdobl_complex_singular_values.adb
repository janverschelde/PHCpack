...
package body TripDobl_Complex_Singular_Values is
...
-- AUXILIARY BLAS ROUTINES :
  ...
  function dmax1 ( x1,x2 : triple_double ) return triple_double is
  ...
  function dmax1 ( x1,x2,x3 : triple_double ) return triple_double is
  ...
  function dmax1 ( x1,x2,x3,x4 : triple_double ) return triple_double is
  ...
  function dmax1 ( x1,x2,x3,x4,x5 : triple_double ) return triple_double is
  ...
  function cabs1 ( z : Complex_Number ) return triple_double is
  ...
  function cdabs ( z : Complex_Number ) return triple_double is
...
--                   raise;
  ...
  --   and continueing n steps with increment incx.
    ...
    norm,scale,ssq,temp : triple_double;
...
--    when others => put_line("exception caught by zdotc"); raise;
  ...
  procedure drotg ( da,db,c,s : in out triple_double ) is
...
-- TARGET PROCEDURE :
  ...
  procedure SVD ( x : in out Matrix; n,p : in integer32;
    ...
    zero : constant triple_double := create(0.0);
    one : constant triple_double := create(1.0);
    minusone : constant triple_double := create(-1.0);
...
--         raise;
  ...
  function Inverse_Condition_Number
             ( s : Vector ) return triple_double is

    smax : constant triple_double := AbsVal(s(s'first));
    one : constant triple_double := create(1.0);
    smin,val : triple_double;
  ...
  function Inverse_Condition_Number
             ( s : Vector; tol : double_float ) return triple_double is
...
end TripDobl_Complex_Singular_Values;
