...
package body Standard_Complex_QR_Least_Squares is
...
-- AUXILIARIES :
  ...
  --   corresponds to the `cdabs' fortran function.
    ...
    res : constant double_float := SQRT(REAL_PART(a)**2 + IMAG_PART(a)**2);
  ...
  function znrm2 ( a : Standard_Complex_Matrices.Matrix;
                   row,col : integer32 )
  ...
  function zdot ( a : Standard_Complex_Matrices.Matrix;
                  row,k1,k2 : integer32 ) 
  ...
  procedure Basis ( qr : in out Standard_Complex_Matrices.Matrix;
    ...
    sum : Complex_Number;
    wrk : Standard_Complex_Vectors.Vector(qr'range(1));
...
end Standard_Complex_QR_Least_Squares;
