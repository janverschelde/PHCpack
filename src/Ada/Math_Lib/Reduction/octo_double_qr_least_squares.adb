...
package body Octo_Double_QR_Least_Squares is
  ...
  function dsign ( a,b : octo_double ) return octo_double is
  ...
  procedure dswap ( a : in out Octo_Double_Matrices.Matrix;
  ...
  procedure dcopy ( n,start : in integer32;
                    x : in Octo_Double_Vectors.Vector;
                    y : out Octo_Double_Vectors.Vector ) is
  ...
  function dnrm2 ( a : Octo_Double_Matrices.Matrix;
                   row,col : integer32 ) return octo_double is
  ...
  function ddot ( a : Octo_Double_Matrices.Matrix;
                  row,k1,k2 : integer32 ) return octo_double is
  ...
  function ddot ( row : integer32;
                  x : Octo_Double_Matrices.Matrix;
                  y : Octo_Double_Vectors.Vector )
  ...
  procedure daxpy ( a : in out Octo_Double_Matrices.Matrix; 
                    f : in octo_double; row,k1,k2 : in integer32 ) is
  ...
  procedure daxpy ( n,row,col : in integer32; f : in octo_double;
                    x : in Octo_Double_Matrices.Matrix;
                    y : in out Octo_Double_Vectors.Vector ) is
  ...
  procedure dscal ( a : in out Octo_Double_Matrices.Matrix;
                    f : in octo_double; row,col : in integer32 ) is
  ...
  procedure QRD ( x : in out Octo_Double_Matrices.Matrix;
                  qraux : in out Octo_Double_Vectors.Vector;
    ...
    work : Octo_Double_Vectors.Vector(x'range(2));
    jj,jp,lp1,lup,maxj,pl,pu : integer32;
    maxnrm,tt,nrmxl,t : octo_double;
    negj,swapj : boolean;
  ...
  procedure Permute_Columns ( x : in out Octo_Double_Matrices.Matrix;
                              jpvt : in Standard_Integer_Vectors.Vector ) is

    res : Octo_Double_Matrices.Matrix(x'range(1),x'range(2));
  ...
  procedure Permute ( x : in out Octo_Double_Vectors.Vector;
                      jpvt : in Standard_Integer_Vectors.Vector ) is
  ...
  procedure Basis ( qr : in out Octo_Double_Matrices.Matrix;
                    x : in Octo_Double_Matrices.Matrix ) is

    sum : octo_double;
    wrk : Octo_Double_Vectors.Vector(qr'range(1));
  ...
  procedure QRLS ( x : in out Octo_Double_Matrices.Matrix;
                   ldx,n,k : in integer32;
                   qraux,y : in Octo_Double_Vectors.Vector;
                   qy,qty,b,rsd,xb : out Octo_Double_Vectors.Vector;
...
end Octo_Double_QR_Least_Squares;
