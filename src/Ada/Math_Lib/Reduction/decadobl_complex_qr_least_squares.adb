...
package body DecaDobl_Complex_QR_Least_Squares is
  ...
  function cdabs ( a : Complex_Number ) return deca_double is
  ...
  procedure zswap ( a : in out DecaDobl_Complex_Matrices.Matrix;
  ...
  procedure zcopy ( n,start : in integer32;
                    ...
                    y : out DecaDobl_Complex_Vectors.Vector ) is
  ...
  function znrm2 ( a : DecaDobl_Complex_Matrices.Matrix;
                   row,col : integer32 ) return deca_double is
  ...
  function zdot ( a : DecaDobl_Complex_Matrices.Matrix;
                  row,k1,k2 : integer32 ) 
  ...
  function zdotc ( row : integer32;
                   x : DecaDobl_Complex_Matrices.Matrix;
                   y : DecaDobl_Complex_Vectors.Vector )
                 return Complex_Number is
  ...
  procedure zaxpy ( a : in out DecaDobl_Complex_Matrices.Matrix; 
  ...
  procedure zscal ( a : in out DecaDobl_Complex_Matrices.Matrix;
  ...
  procedure zaxpy ( n,row,col : in integer32; f : in Complex_Number;
                    x : in DecaDobl_Complex_Matrices.Matrix;
                    y : in out DecaDobl_Complex_Vectors.Vector ) is
  ...
  procedure QRD ( x : in out DecaDobl_Complex_Matrices.Matrix;
                  qraux : in out DecaDobl_Complex_Vectors.Vector;
  ...
  procedure Basis ( qr : in out DecaDobl_Complex_Matrices.Matrix;
                    x : in DecaDobl_Complex_Matrices.Matrix ) is

    sum : Complex_Number;
    wrk : DecaDobl_Complex_Vectors.Vector(qr'range(1));
  ...
  procedure QRLS ( x : in out DecaDobl_Complex_Matrices.Matrix;
                   n,k : in integer32;
                   qraux,y : in DecaDobl_Complex_Vectors.Vector;
                   qy,qty,b,rsd,xb : out DecaDobl_Complex_Vectors.Vector;
...
end DecaDobl_Complex_QR_Least_Squares;
