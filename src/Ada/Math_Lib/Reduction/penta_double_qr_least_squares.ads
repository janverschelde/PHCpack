...
package Penta_Double_QR_Least_Squares is

-- DESCRIPTION :
--   This package provides an implementation of QR-decomposition for
--   matrices in penta double precision.  With this decomposition,
...
--   least squares sense.
  ...
  -- DESCRIPTION :
  --   Applies the output of Penta_Double_QR_Decomposition.QRD to
