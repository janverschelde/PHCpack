...
package body OctoDobl_Complex_Linear_Solvers is

-- AUXLILIARIES :

  function cabs ( c : Complex_Number ) return octo_double is
  begin
...
-- TARGET ROUTINES :
  ...
  procedure Scale ( a : in out OctoDobl_Complex_Matrices.Matrix;
                    b : in out OctoDobl_Complex_Vectors.Vector ) is

    fac : Complex_Number;

    function Maximum ( a : in OctoDobl_Complex_Matrices.Matrix;
                       i : in integer32 ) return Complex_Number is

      res : integer32 := a'first(2);
      max : octo_double := cabs(a(i,res));
      tmp : octo_double;
    ...
    procedure Divide ( a : in out OctoDobl_Complex_Matrices.Matrix;
  ...
  function Norm1 ( a : OctoDobl_Complex_Matrices.Matrix )
  ...
  function Norm1 ( a : OctoDobl_Complex_VecVecs.VecVec )
                 return octo_double is

    res : octo_double := Create(0.0);
    sum : octo_double;
    aj : OctoDobl_Complex_Vectors.Link_to_Vector;
...
-- TARGET ROUTINES :
  ...
  procedure lufac ( a : in out OctoDobl_Complex_Matrices.Matrix;
    ...
    smax : octo_double;
    temp : Complex_Number;
    dd_min_one : constant octo_double := create(-1.0);
  ...
  procedure lufac ( a : in out OctoDobl_Complex_VecVecs.VecVec;
    ...
    smax : octo_double;
    temp : Complex_Number;
    ak,aj : OctoDobl_Complex_Vectors.Link_to_Vector;
    dd_min_one : constant octo_double := create(-1.0);
    cp_min_one : constant Complex_Number := create(dd_min_one);
  ...
  procedure estco ( a : in OctoDobl_Complex_Matrices.Matrix;
                    ...
                    anorm : in octo_double; rcond : out octo_double ) is

    z : OctoDobl_Complex_Vectors.Vector(1..n);
    kb,kp1,l : integer32;
    s,sm,sum,ynorm : octo_double;
  ...
  procedure lufco ( a : in out OctoDobl_Complex_Matrices.Matrix;
    ...
    anorm : constant octo_double := Norm1(a);
    info : integer32;
  ...
  procedure lusolve ( a : in OctoDobl_Complex_VecVecs.VecVec;
    ...
    ell,nm1,kb : integer32;
    ak : OctoDobl_Complex_Vectors.Link_to_Vector;
    temp : Complex_Number;
  ...
  begin
    ...
    while (k <= n) and (kcolumn <= m) loop
      ...
      if is_zero(max) then
        ...
        a(k,kcolumn) := OctoDobl_Complex_Numbers.Create(integer(1));
        for i in 1..(k-1) loop
          for j in (kcolumn+1)..m loop
            a(i,j) := a(i,j) - a(i,kcolumn) * a(k,j);
          end loop;
...
-- TO TEST THE LU FACTORIZATION :
  ...
  function Permute ( P : Standard_Natural_Matrices.Matrix;
    ...
    fP : OctoDobl_Complex_Matrices.Matrix(P'range(1),P'range(2));
