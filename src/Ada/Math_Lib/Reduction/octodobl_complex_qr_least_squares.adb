...
package body OctoDobl_Complex_QR_Least_Squares is
  ...
  function cdabs ( a : Complex_Number ) return octo_double is
  ...
  procedure zswap ( a : in out OctoDobl_Complex_Matrices.Matrix;
  ...
  procedure zcopy ( n,start : in integer32;
                    ...
                    y : out OctoDobl_Complex_Vectors.Vector ) is
  ...
  function znrm2 ( a : OctoDobl_Complex_Matrices.Matrix;
  ...
  function zdot ( a : OctoDobl_Complex_Matrices.Matrix;
                  row,k1,k2 : integer32 ) 
  ...
  function zdotc ( row : integer32;
                   x : OctoDobl_Complex_Matrices.Matrix;
                   y : OctoDobl_Complex_Vectors.Vector )
                 return Complex_Number is
  ...
  procedure zaxpy ( a : in out OctoDobl_Complex_Matrices.Matrix; 
  ...
  procedure zscal ( a : in out OctoDobl_Complex_Matrices.Matrix;
  ...
  procedure zaxpy ( n,row,col : in integer32; f : in Complex_Number;
                    ...
                    y : in out OctoDobl_Complex_Vectors.Vector ) is
  ...
  procedure Basis ( qr : in out OctoDobl_Complex_Matrices.Matrix;
                    x : in OctoDobl_Complex_Matrices.Matrix ) is

    sum : Complex_Number;
    wrk : OctoDobl_Complex_Vectors.Vector(qr'range(1));
