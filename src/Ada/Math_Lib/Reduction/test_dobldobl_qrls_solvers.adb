...
package body Test_DoblDobl_QRLS_Solvers is
  ...
  begin
    loop
      ...
      put_line("  1. QR-decomposition on given dobldobl real matrix.");
      put_line("  2.                                    complex matrix.");
      put_line("  3.                  on random dobldobl real matrix.");
      put_line("  4.                                     complex matrix.");
      put_line("  5. Least Squares on given dobldobl real matrix.");
      put_line("  6.                        dobldobl complex matrix.");
      put_line("  7.               on random dobldobl real matrix.");
