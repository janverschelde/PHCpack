...
package Standard_Floating_Singular_Values is

-- DESCRIPTION :
--   This package provides a facility for computing a singular value
--   decomposition of matrices of standard real floating-point numbers.
...
--   The current implementation is just an interface to the complex SVD.  
  ...
  function Transpose ( z : Matrix ) return Matrix;

  -- DESCRIPTION :
  --   Returns the transpose of the matrix z.
