...
-- ROUTINES USING DOUBLE DOUBLE ARITHMETIC :

  function Read_Vector
             ( n : in integer32 ) return DoblDobl_Complex_Vectors.Vector is
  ...
  function Read_Matrix
             ( n,m : in integer32 ) return DoblDobl_Complex_Matrices.Matrix is
  ...
  function Is_Identity ( a : DoblDobl_Complex_Matrices.Matrix;
                         tol : double_float ) return boolean is
  ...
  function Is_Orthogonal ( a : DoblDobl_Complex_Matrices.Matrix;
                           tol : double_float ) return boolean is
  ...
  function Is_SVD ( x,u,v : DoblDobl_Complex_Matrices.Matrix;
                    s : DoblDobl_Complex_Vectors.Vector;
                    tol : in double_float ) return boolean is
  ...
  procedure Test_SVD_Solver
               ( a,u,v : in DoblDobl_Complex_Matrices.Matrix;
                 s,b : in DoblDobl_Complex_Vectors.Vector ) is
  ...
  procedure DoblDobl_Test_SVD_on_Given_Matrix ( n,p : in integer32 ) is
  ...
  begin
    SVD(x,n,p,s,e,u,v,job,info);
    Test_SVD_Output(y,u,v,s,e,info);
  end DoblDobl_Test_SVD_on_Given_Matrix;

  procedure DoblDobl_Test_SVD_on_Given_System ( n,p : in integer32 ) is
  ...
  begin
    ...
    Test_SVD_Output(y,u,v,s,e,info);
    Test_SVD_Solver(y,u,v,s,b);
  end DoblDobl_Test_SVD_on_Given_System;

  procedure DoblDobl_Test_SVD_on_Random_Matrix ( n,p : in integer32 ) is
  ...
  begin
    SVD(x,n,p,s,e,u,v,job,info);
    Test_SVD_Output(y,u,v,s,e,info);
  end DoblDobl_Test_SVD_on_Random_Matrix;

  procedure DoblDobl_Test_SVD_on_Random_System ( n,p : in integer32 ) is
...
-- ROUTINES USING MULTIPRECISION ARITHMETIC :
  ...
  begin
    ...
    case prec is
      ...
      when '1' =>
        case ans is
          when '1' => DoblDobl_Test_SVD_on_Given_Matrix(n,m);
          when '2' => DoblDobl_Test_SVD_on_Given_System(n,m);
          when '3' => DoblDobl_Test_SVD_on_Random_Matrix(n,m);
          when '4' => DoblDobl_Test_SVD_on_Random_System(n,m);
          when others => null;
      end case;
      when '2' =>
        case ans is
