...
package OctoDobl_Circuit_Makers is
...
--   Coefficients of the circuits are of octo double precision.
  ...
  procedure Write_Matrix ( A : in OctoDobl_Complex_Matrices.Matrix );
