...
package Test_QuadDobl_Speel_Convolutions is

-- DESCRIPTION :
--   A vectorized version of the computation of Speelpenning products
--   for truncated power series in quad double precision.

  procedure QuadDobl_Test ( dim,deg : in integer32 );
...
end Test_QuadDobl_Speel_Convolutions;
