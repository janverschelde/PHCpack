...
-- CREATORS :
  ...
  function Create ( n : natural32 ) return Array_of_Naturals;

  -- DESCRIPTION :
  --   Returns the representation of the natural number as coefficient vector.

  function Create ( i : integer ) return Natural_Number;

  -- DESCRIPTION :
  --   Returns the representation of i as a natural number.

  function Create ( n : natural32 ) return Natural_Number;
  ...
  function Create ( n : Natural_Number ) return natural32;
...
-- SELECTORS :
  ...
  function Decimal_Places ( n : natural32 ) return natural32;
  ...
  function Coefficient ( n : Natural_Number; i : natural32 ) return natural32;
...
-- COMPARISON AND COPYING :
  ...
  function Equal ( n1 : Natural_Number; n2 : natural32 ) return boolean;
  function Equal ( n1,n2 : Natural_Number ) return boolean;

  -- DESCRIPTION :
  --   Returns true when both numbers n1 and n2 are equal, false otherwise.

  function "<" ( n1 : Natural_Number; n2 : natural32 ) return boolean;
  function "<" ( n1 : natural32; n2 : Natural_Number ) return boolean;
  ...
  procedure Copy ( n1 : in natural32; n2 : in out Natural_Number );
...
--   The unary "-" operations have been added to make it ring-like.
  ...
  function "+" ( n1 : Natural_Number; n2 : natural32 ) return Natural_Number;
  function "+" ( n1 : natural32; n2 : Natural_Number ) return Natural_Number;
  ...
  function "/" ( n1 : Natural_Number; n2 : natural32 ) return Natural_Number;
  function "/" ( n1 : natural32; n2 : Natural_Number ) return natural32;
  function "/" ( n1,n2 : Natural_Number ) return Natural_Number;

  function Rmd ( n1 : Natural_Number; n2 : natural32 ) return natural32;
  function Rmd ( n1 : natural32; n2 : Natural_Number ) return natural32;
...
-- ARITHMETIC OPERATIONS as procedures for memory management :
  ...
  procedure Add ( n1 : in out Natural_Number; n2 : in natural32 );    -- "+"
  procedure Add ( n1 : in out Natural_Number; n2 : in Natural_Number );

  procedure Sub ( n1 : in out Natural_Number; n2 : in natural32 );    -- "-"
  procedure Sub ( n1 : in out Natural_Number; n2 : in Natural_Number );
  procedure Min ( n : in out Natural_Number );

  procedure Mul ( n1 : in out Natural_Number; n2 : in natural32 );    -- "*"
  ...
  procedure Div ( n1 : in Natural_Number; n2 : in natural32;  -- n1 = n2*q+r
                  q : out Natural_Number; r : out natural32 );
  procedure Div ( n1 : in out Natural_Number; n2 : in natural32;
                  r : out natural32 );
