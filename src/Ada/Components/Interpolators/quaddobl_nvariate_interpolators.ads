...
package QuadDobl_Nvariate_Interpolators is
...
--   in QuadDobl floating-point arithmetic.
...
-- DIAGNOSTICS :
  ...
  function Maximal_Error ( x : VecVec; y,f : NesVec ) return quad_double;

  -- DESCRIPTION :
  --   Returns the maximal difference between sampled and evaluated points.

end QuadDobl_Nvariate_Interpolators;
