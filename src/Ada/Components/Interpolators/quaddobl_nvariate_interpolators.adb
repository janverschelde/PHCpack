...
package body QuadDobl_Nvariate_Interpolators is
...
-- EVALUATORS WITH HORNER :
  ...
  begin
   ...
   -- res := Eval0(f,x,a);           -- RECOURSE TO QuadDobl EVAL
    return res;
  end Eval;
...
-- DIAGNOSTICS :
  ...
  function Maximal_Error ( x : VecVec; y,f : NesVec ) return quad_double is
