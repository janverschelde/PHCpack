...
-- THE TARGET OPERATIONS :
  ...
  begin
    restricted := false;
    stansys := new Standard_Complex_Laur_Systems.Laur_Sys'(ep);
    stansys_eval := new Eval_Laur_Sys'(Create(ep));
  ...
  begin
    restricted := true;
    rststansys := new Standard_Complex_Laur_Systems.Laur_Sys'(ep);
    rststansys_eval := new Eval_Laur_Sys'(Create(ep));
  ...
  procedure Initialize ( ep : in Standard_Complex_Laur_Systems.Laur_Sys;
    ...
    stjac : Standard_Complex_Laur_JacoMats.Jaco_Mat(ep'range,ep'range)
          := Standard_Complex_Laur_JacoMats.Create(ep);
    stjac_eval : constant Standard_Complex_Laur_JacoMats.Eval_Jaco_Mat
                   (ep'range,ep'range)
               := Standard_Complex_Laur_JacoMats.Create(stjac);
  ...
  begin
    ...
    stansys_eval
      := new Standard_Complex_Laur_SysFun.Eval_Laur_Sys'
               (Standard_Complex_Laur_SysFun.Create(ep));
    stanjac_eval := new Standard_Complex_Laur_JacoMats.Eval_Jaco_Mat'
                          (stjac_eval);
  ...
  begin
    ...
    rststansys_eval
      := new Standard_Complex_Laur_SysFun.Eval_Laur_Sys'
               (Standard_Complex_Laur_SysFun.Create(ep));
    rststanjac_eval := new Standard_Complex_Laur_JacoMats.Eval_Jaco_Mat'
                             (stjac_eval);
    Standard_Complex_Laur_JacoMats.Clear(stjac);
    for i in ep'first..ep'last-k loop
      mps(i) := Embed(mp(i),ep(i),mp'last,k,size);
