// The file dbl8_qrbs_testers.h specifies test functions on
// the blocked accelerated QR decomposition and
// the tiled back substitution in octo double precision.

#ifndef __dbl8_qrbs_testers_h__
#define __dbl8_qrbs_testers_h__
