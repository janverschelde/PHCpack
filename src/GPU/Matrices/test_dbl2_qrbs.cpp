 ...
 * and tiled accelerated back substitution in double double precision */

#include <iostream>
#include <cstdlib>
#include <time.h>
#include "prompt_baqr_setup.h"
#include "dbl2_qrbs_testers.h"
...
int main ( void )
{
   ...
   test_real2_blocked_qrbs(seed,szt,nbt,nrows,vrb,mode);
   ...
   test_cmplx2_blocked_qrbs(seed,szt,nbt,nrows,vrb,mode);
