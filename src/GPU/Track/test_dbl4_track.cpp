/* Tests a path tracker on series in quad double precision */
...
int main ( void )
{
   cout << "test on path tracking in quad double precision ..." << endl;
