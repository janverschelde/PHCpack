/* Tests a path tracker on series in double double precision */
...
int main ( void )
{
   cout << "test on path tracking in double double precision ..." << endl;
