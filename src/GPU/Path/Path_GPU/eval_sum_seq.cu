...
__global__ void eval_sum_seq_kernel(GT* workspace_matrix, GT* workspace_sum, \
...
// Mon evalutaion and differentiation on GPU
__global__ void eval_sum_seq_kernel(GT* workspace_matrix, GT* workspace_sum, \
		int* sum_pos, int* sum_pos_start, int n_sum, int workspace_size) {
...
// Mon evalutaion and differentiation on GPU
__global__ void eval_sum_seq_kernel(GT* workspace_matrix, GT* workspace_sum, \
		int* sum_pos, int* sum_pos_start, int n_sum, int workspace_size, int* path_idx_mult) {
