...
public:
	...
	void init(int workspace_size, int n_coef, int n_constant, int n_eq, int dim, int n_predictor, int* max_deg_base=NULL);

	Workspace(int workspace_size, int coef_size, int workspace_constant_size, int n_eq, int dim, int n_predictor, int* max_deg_base=NULL){
		init(workspace_size, coef_size, workspace_constant_size, n_eq, dim, n_predictor, max_deg_base);
	}
