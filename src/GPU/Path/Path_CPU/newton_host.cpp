...
bool CPU_Newton_Path(Workspace& workspace_cpu, CPUInstHom& cpu_inst_hom, Parameter path_parameter,
                double& timeSec_Eval, double& timeSec_MGS, int reverse){
    //cout << "Newton max_it = " << path_parameter.max_it << " err_max_delta_x = " << path_parameter.err_max_delta_x << endl;
...
bool CPU_Newton_Refine
 ( Workspace& workspace_cpu, CPUInstHom& cpu_inst_hom, Parameter path_parameter,
                double& timeSec_Eval, double& timeSec_MGS, int reverse){
    //cout << "Newton max_it = " << path_parameter.max_it << " err_max_delta_x = " << path_parameter.err_max_delta_x << endl;
