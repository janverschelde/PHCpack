...
bool init_homotopy_test(PolySys& Target_Sys, PolySys& Start_Sys, PolySolSet& sol_set, int dim, int& n_eq, \
		       CT*& sol0, CPUInstHom& cpu_inst_hom, Workspace& workspace_cpu, int test, int n_predictor, \
		   	string start_sys_filename,	string target_sys_filename){
...
bool init_homotopy_test_ada(PolySys& Target_Sys, PolySys& Start_Sys, \
