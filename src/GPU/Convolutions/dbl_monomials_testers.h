/* The dbl_monomials_testers.h contains the prototypes of functions to test
 * monomial evaluation and differentiation in double precision. */

#ifndef __dbl_monomials_testers_h__
#define __dbl_monomials_testers_h__
