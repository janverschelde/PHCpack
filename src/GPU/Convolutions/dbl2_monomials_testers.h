/* The dbl2_monomials_testers.h contains the prototypes of functions to test
 * monomial evaluation and differentiation in double double precision. */

#ifndef __dbl2_monomials_testers_h__
#define __dbl2_monomials_testers_h__
