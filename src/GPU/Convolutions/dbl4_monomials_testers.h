/* The dbl4_monomials_testers.h contains the prototypes of functions to test
 * monomial evaluation and differentiation in quad double precision. */

#ifndef __dbl4_monomials_testers_h__
#define __dbl4_monomials_testers_h__
