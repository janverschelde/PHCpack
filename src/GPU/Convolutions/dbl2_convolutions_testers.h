/* The file dbl2_convolutions_testers.h contains the prototypes of
 * functions to test the product of two series in double double precision. */

#ifndef __dbl2_convolutions_testers_h__
#define __dbl2_convolutions_testers_h__
...
/*
 * DESCRIPTION :
 *   Runs six tests on convolutions in double double precision.
