/* The dbl5_monomials_testers.h contains the prototypes of functions to test
 * monomial evaluation and differentiation in penta double precision. */

#ifndef __dbl5_monomials_testers_h__
#define __dbl5_monomials_testers_h__
 ...
 *   pwr      highest power of each variable;
 *   deg      truncation degree of the series;
 *   verbose  if zero, the no output is written. */
