/* The file dbl_convolutions_testers.h contains the prototypes of
 * functions to test the product of two series in double precision. */

#ifndef __dbl_convolutions_testers_h__
#define __dbl_convolutions_testers_h__
...
/*
 * DESCRIPTION :
 *   Runs six tests on convolutions in double precision.
