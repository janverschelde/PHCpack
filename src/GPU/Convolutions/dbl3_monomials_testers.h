/* The dbl3_monomials_testers.h contains the prototypes of functions to test
 * monomial evaluation and differentiation in triple double precision. */

#ifndef __dbl3_monomials_testers_h__
#define __dbl3_monomials_testers_h__
