...
int main ( void )
{
   cout << "testing Newton in double double precision ..." << endl;
   ...
   if(nbritr == -5)
      fail = dbl2_test_rows(dim,deg,vrblvl,nbsteps,szt,nbt,mode,cdata);
   else
      fail = dbl2_test_columns(dim,deg,size,vrblvl,nbritr,nbrcol,
