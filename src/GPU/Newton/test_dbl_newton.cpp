...
int main ( void )
{
   ...
   if(nbritr == -5)
      fail = dbl_test_rows(dim,deg,vrblvl,nbsteps,szt,nbt,mode,cdata);
   else
      fail = dbl_test_columns(dim,deg,size,vrblvl,nbritr,nbrcol,
