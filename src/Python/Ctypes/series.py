...
from polynomials import string_of_symbols
from polynomials import set_double_system, get_double_system
from polynomials import number_of_symbols, copy_from_double_syspool
from polynomials import size_double_syspool
