...
target functions in a homotopy.  There are twelve copy functions:
...
def test_double_start_system(vrblvl=0):
    """
    Tests the defition of a start system in double precision.
    """
    if vrblvl > 0:
...
def test_double_double_start_system(vrblvl=0):
    """
    Tests the defition of a start system in double double precision.
    """
    if vrblvl > 0:
...
def test_quad_double_start_system(vrblvl=0):
    """
    Tests the defition of a start system in quad double precision.
    """
    if vrblvl > 0:
