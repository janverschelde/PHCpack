...
def store_standard_witness_set(nbvar, dim, pols, sols):
    ...
    """
    from phcpy.phcpy2c2 import py2c_swap_symbols_for_standard_witness_set
...
def store_dobldobl_witness_set(nbvar, dim, pols, sols):
    ...
    symbol table in both the polynomials and the solutions.
    """
    from phcpy.phcpy2c2 import py2c_swap_symbols_for_dobldobl_witness_set
...
def store_quaddobl_witness_set(nbvar, dim, pols, sols):
    ...
    symbol table in both the polynomials and the solutions.
    """
    from phcpy.phcpy2c2 import py2c_swap_symbols_for_quaddobl_witness_set
