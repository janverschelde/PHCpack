...
def monomial_map_strings(dim, ind, nbvar):
    ...
    """
    from phcpy.phcpy2c2 import py2c_mapcon_coefficients_of_map
    from phcpy.phcpy2c2 import py2c_mapcon_exponents_of_map
...
def solve_binomials(nbvar, pols, silent=True, puretopdim=False):
    ...
    """
    from phcpy.phcpy2c2 import py2c_syscon_write_standard_Laurent_system
    from phcpy.phcpy2c2 import py2c_mapcon_solve_system
    from phcpy.phcpy2c2 import py2c_mapcon_write_maps
    from phcpy.phcpy2c2 import py2c_mapcon_clear_maps
