...
{
   int fail = _ada_use_c2phc4c(272,&max,nit,&eps);
...
{
   int fail = _ada_use_c2phc4c(273,&max,nit,&eps);
...
{
   int fail = _ada_use_c2phc4c(274,&max,nit,&eps);
...
{
   int fail = _ada_use_c2phc4c(275,&max,nit,&eps);
